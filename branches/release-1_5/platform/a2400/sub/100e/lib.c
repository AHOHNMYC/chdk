...
char *hook_raw_image_addr()     {return (char*) 0x420B7FC0;} //Found @0xffae418c Search for BJPEG BUFF
char *hook_alt_raw_image_addr() {return (char*) 0x420B7FC0;} //Found @0xffae418c Search for BJPEG BUFF
