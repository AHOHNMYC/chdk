...
"loc_FF1B8444:\n"
"    LDR     R1, [SP, #4] \n"
"    LDR     R3, =0xFF1B5D88 /*'MovieRecorder.c'*/ \n"
"    STR     R5, [R1] \n"
"    STR     R9, [SP] \n"
"    LDR     R0, [R4, #0x28] \n"
"    MOV     R2, R10 \n"
...
"loc_FF1B792C:\n"
"    LDR     R0, =0xFF1B5D88 /*'MovieRecorder.c'*/ \n"
"    MOV     R1, #0x790 \n"
"    BL      _DebugAssert \n"
...
"    LDR     R7, [SP, #0x38] \n"
"    LDREQ   R1, =0x36A \n"
"    LDREQ   R0, =0xFF34B71C /*'MovWriter.c'*/ \n"
"    MOV     R6, #0 \n"
"    MOV     R4, R3 \n"
"    MOV     R5, R6 \n"
"    BLEQ    _DebugAssert \n"
...
"    CMP     R0, #0x10 \n"
"    LDRNE   R1, =0x48D \n"
"    LDRNE   R0, =0xFF34B71C /*'MovWriter.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    MOV     R0, #1 \n"
"    STR     R0, [R11, #0xDC] \n"
"    LDRH    R0, [R11, #4] \n"
