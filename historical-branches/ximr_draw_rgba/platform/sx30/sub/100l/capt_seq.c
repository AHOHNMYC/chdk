...
"    TST     R0, #1 \n"
"    MOVNE   R1, #0xC3 \n"
"    LDRNE   R0, =0xFF993030 /*'SsCaptureSeq.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDRH    R0, [SP] \n"
"    CMP     R0, #1 \n"
"    STRHI   R6, [R4, #0xD4] \n"
...
"    TST     R0, #1 \n"
"    LDRNE   R1, =0x1F6 \n"
"    LDRNE   R0, =0xFFAECE28 /*'SsStandardCaptureSeq.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    BL      sub_FF889A04 \n"
"    MOV     R0, R4 \n"
"    CMP     R0, #1 \n"
...
"loc_FFAECD90:\n"
"    MOV     R1, #0x22C \n"
"    LDR     R0, =0xFFAECE28 /*'SsStandardCaptureSeq.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    STR     R3, [SP] \n"
"    LDR     R2, =0x3A98 \n"
"    LDR     R3, =0xFFAECE28 /*'SsStandardCaptureSeq.c'*/ \n"
"    MOV     R1, #4 \n"
"    BL      sub_FF88C9C8 \n"
"    CMP     R0, #0 \n"
"    MOVNE   R1, #0x244 \n"
