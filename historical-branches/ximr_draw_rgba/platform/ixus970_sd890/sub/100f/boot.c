...
void taskCreateHook(int *p)
{
	...
	if (p[0]==(int)0xFF842A40)  p[0]=(int)jogdial_task_my; 
	if (p[0]==(int)0xFF859F88)  p[0]=(int)movie_record_task;
	if (p[0]==(int)0xFF85DFC0)  p[0]=(int)capt_seq_task;
	if (p[0]==(int)0xFF878F08)  p[0]=(int)init_file_modules_task;
	if (p[0]==(int)0xFF8B67E8)  p[0]=(int)exp_drv_task;
	if (p[0]==(int)0xFFA101b8)  p[0]=(int)filewritetask;
}
...
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
"    B       CreateTask_Startup_my \n"  // --> Patched. Old value = 0xFF81CCBC.
);
}

/*************************************************************/
//** CreateTask_Startup_my @ 0xFF81CCBC - 0xFF81CD28, length=28
...
"    MOV     R0, #0 \n"
"    BL      sub_FF8284AC \n"
"    BL      sub_FF828458 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF81CC60.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF81CD34 /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R12,PC} \n"
);
...
/*************************************************************/
//** task_Startup_my @ 0xFF81CC60 - 0xFF81CCB8, length=23
...
/*************************************************************/
//** init_file_modules_task @ 0xFF878F08 - 0xFF878F3C, length=14
...
/*************************************************************/
//** sub_FF86D844_my @ 0xFF86D844 - 0xFF86D87C, length=15
void __attribute__((naked,noinline)) sub_FF86D844_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    BL      sub_FF84EF30_my \n"  // --> Patched. Old value = 0xFF84EF30.
"    LDR     R4, =0x57D0 \n"
"    LDR     R0, [R4, #4] \n"
"    CMP     R0, #0 \n"
"    BNE     loc_FF86D874 \n"
...
/*************************************************************/
//** sub_FF84EF30_my @ 0xFF84EF30 - 0xFF84EFC8, length=39
...
/*************************************************************/
//** sub_FF84ED6C_my @ 0xFF84ED6C - 0xFF84EDD4, length=27
...
/*************************************************************/
//** sub_FF84EAFC_my @ 0xFF84EAFC - 0xFF84EC60, length=90
...
/*************************************************************/
//** jogdial_task_my @ 0xFF842A40 - 0xFF842B38, length=63
void __attribute__((naked,noinline)) jogdial_task_my() {
asm volatile (
"    STMFD   SP!, {R3-R11,LR} \n"
"    BL      sub_FF842BF0 \n"
...
"    LDR     R3, =0x1A1 \n"
"    LDR     R0, [R6, #0xC] \n"
"    LDR     R2, =0xFF842C98 /*'JogDial.c'*/ \n"
"    MOV     R1, #0 \n"
"    BL      sub_FF81BBD8 /*_TakeSemaphoreStrictly*/ \n"
"    MOV     R0, #0x28 \n"
"    BL      _SleepTask \n"
//------------------  added code ---------------------
"labelA:\n"
