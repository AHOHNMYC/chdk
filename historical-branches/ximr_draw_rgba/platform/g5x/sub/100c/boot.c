...
asm volatile (
            "    movs    r0, #3\n"
            "    push    {r4, lr}\n"
            "    bl      sub_fc3b711c_my\n" // Patched (was sub_fc3b711c)
            "    ldr     pc, =0xfc0c997f\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b711c_my @ 0xFC3B711D, length=26 jfw
void __attribute__((naked,noinline)) sub_fc3b711c_my() {
asm volatile (
            ...
            "    bl      sub_fc3b6a88\n"
            "    mov     r0, r5\n"
            "    bl      sub_fc3b6cea_my\n" // Patched (was sub_fc3b6cea)
            "    ldr     pc, =0xfc3b7163\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b6cea_my @ 0xFC3B6CEB, length=11 jfw
void __attribute__((naked,noinline)) sub_fc3b6cea_my() {
asm volatile (
            "    push    {r4, r5, r6, lr}\n"
            "    mov     r5, r0\n"
            "    ldr     r0, =0x00044368\n"
            ...
            "    ldr     r0, [r4, #0x38]\n"
            "    mov     r1, r5\n"
            "    bl      sub_fc3b6ae6_my\n" // Patched (was sub_fc3b6ae6)
            "    ldr     pc, =0xfc3b6d03\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b6ae6_my @ 0xFC3B6AE7, length=108 
void __attribute__((naked,noinline)) sub_fc3b6ae6_my() {
asm volatile (
            ...
            "branchtable_fc3b6b04:\n"
            "    .byte((loc_fc3b6b1c - branchtable_fc3b6b04) / 2)\n" // (case 0)
            "    .byte((loc_fc3b6b0c - branchtable_fc3b6b04) / 2)\n" // (case 1)
            "    .byte((loc_fc3b6b0c - branchtable_fc3b6b04) / 2)\n" // (case 2)
            "    .byte((loc_fc3b6b0c - branchtable_fc3b6b04) / 2)\n" // (case 3)
            "    .byte((loc_fc3b6b0c - branchtable_fc3b6b04) / 2)\n" // (case 4)
            "    .byte((loc_fc3b6bdc - branchtable_fc3b6b04) / 2)\n" // (case 5)
            "    .byte((loc_fc3b6b0c - branchtable_fc3b6b04) / 2)\n" // (case 6)
            ".align 1\n"
            "loc_fc3b6b0c:\n"
            "    movs    r2, #0\n"
...
/*************************************************************/
//** task_TricInitTask_my @ 0xFC54224D, length=35 
