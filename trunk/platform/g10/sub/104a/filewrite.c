...
/*************************************************************/
//** filewritetask @ 0xFFA46A28 - 0xFFA46B0C, length=58
...
/*************************************************************/
//** sub_FFA46D80_my @ 0xFFA46D80 - 0xFFA46DC0, length=17
void __attribute__((naked,noinline)) sub_FFA46D80_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
"    ADD     R0, R0, #0x34 \n"
...
/*************************************************************/
//** sub_FFA46E80_my @ 0xFFA46E80 - 0xFFA46F88, length=67
void __attribute__((naked,noinline)) sub_FFA46E80_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0] \n"
...
"    CMP     R5, R6 \n"
"    ADD     R7, R7, R0 \n"
"    LDRCS   R0, =0xFFA46D6C /*'dwFWrite.c'*/ \n"
"    MOVCS   R1, #0x234 \n"
"    BLCS    _DebugAssert \n"
"    CMP     R5, #0 \n"
"    BNE     loc_FFA46EF8 \n"
...
/*************************************************************/
//** sub_FFA46F8C_my @ 0xFFA46F8C - 0xFFA47028, length=40
void __attribute__((naked,noinline)) sub_FFA46F8C_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R5, =0xC8F4 \n"
"    MOV     R4, R0 \n"
