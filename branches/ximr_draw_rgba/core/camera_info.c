...
_cam_screen camera_screen =
{
    ...
    CAM_TS_BUTTON_BORDER, CAM_SCREEN_WIDTH-CAM_TS_BUTTON_BORDER-1, CAM_SCREEN_WIDTH-CAM_TS_BUTTON_BORDER*2,
    EDGE_HMARGIN,
...
_cam_info camera_info =
{
    ...
    0,
#endif
    PROPCASE_SHOOTING, PROPCASE_RESOLUTION, PROPCASE_QUALITY, PROPCASE_AF_LOCK
    },
...
void camera_info_init()
{
    ...
    // gui_mode and gui_mode_alt default to 0, which is consistent
}
