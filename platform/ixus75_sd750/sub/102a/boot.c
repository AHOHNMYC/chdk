...
void boot()
{
		// Theses values have been modified for the SD750 102a
    long *canon_data_src = (void*)0xFFB95410; 
...
// Found at 0xFF811990
// These values have been modified for the SD750 102a
// Didn't change from the SD750 101a
void h_usrInit()
{
    asm volatile (
	"STR     LR, [SP,#-4]!\n"
