...
/*************************************************************/
//** dvlp_seq_task @ 0xFF07E754 - 0xFF07E828, length=54
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x76 \n"
"    LDREQ   R0, =0xFF07E90C /*'SsDvlpSeq.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    STR     R5, [R4, #4] \n"
"    LDR     R0, [R6, #4] \n"
"    ADD     R1, SP, #4 \n"
...
"    BEQ     loc_FF07C490 \n"
"    LDR     R1, =0x491 \n"
"    LDR     R0, =0xFF07BDA0 /*'SsShootTask.c'*/ \n"
"    BL      _DebugAssert \n"
"    BL      _ExitTask \n"
"    LDMFD   SP!, {R3-R7,PC} \n"
...
"    TST     R0, #1 \n"
"    LDRNE   R1, =0x592 \n"
"    LDRNE   R0, =0xFF07BDA0 /*'SsShootTask.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDRH    R0, [R4, #0x6C] \n"
"    CMP     R0, #1 \n"
"    BLEQ    sub_FF1D3BA0 \n"
...
"    CMP     R0, #0 \n"
"    LDREQ   R1, =0x117 \n"
"    LDREQ   R0, =0xFF07BDA0 /*'SsShootTask.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    STR     R6, [R5, #8] \n"
"    B       loc_FF07C464 \n"
);
...
"    CMP     R0, #1 \n"
"    LDRNE   R1, =0x14D \n"
"    LDRNE   R0, =0xFF0B74BC /*'Shutter.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    CMN     R4, #0xC00 \n"
"    LDREQSH R4, [R5, #2] \n"
"    CMN     R4, #0xC00 \n"
"    LDREQ   R1, =0x153 \n"
"    LDREQ   R0, =0xFF0B74BC /*'Shutter.c'*/ \n"
"    STRH    R4, [R5, #2] \n"
"    BLEQ    _DebugAssert \n"
"    MOV     R0, R4 \n"
