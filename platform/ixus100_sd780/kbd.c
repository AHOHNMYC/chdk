...
void dumpProps() {
    ...
    l=(void*)_Fopen_Fut("A/PropDmp.txt","a");
    for (i=0;i<300;i++){
...
int dump1900_SD780() {
    ...
    //l=(void*)_Fopen_Fut("A/0x1900.bin","ab");
    //_Fwrite_Fut(START_ADDRESS,1,FWSIZE,l);
    //_Fwrite_Fut(0xFF814EC8,1,16,l);
    //_Fflush_Fut(l);
    //_Fclose_Fut(l);
    j=0;

    l=(void*)_Fopen_Fut("A/aHookList.txt","ab");
...
//void* l;
//
//l=(void*)_Fopen_Fut("A/test.bin","w");
//_Fwrite_Fut(MIN_ADDRESS,1,FW_SIZE,l);
//_Fflush_Fut(l);
//_Fclose_Fut(l);
//
