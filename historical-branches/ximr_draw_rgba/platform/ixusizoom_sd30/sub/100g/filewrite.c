...
/*************************************************************/
//** filewritetask @ 0xFF868434 - 0xFF8684C8, length=38
...
/*************************************************************/
//** sub_FF86837C_my @ 0xFF86837C - 0xFF868418, length=40
void __attribute__((naked,noinline)) sub_FF86837C_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R2, =0x1C620 \n"
"    LDRH    R3, [R2] \n"
...
/*************************************************************/
//** sub_FF86822C_my @ 0xFF86822C - 0xFF8682C4, length=39
void __attribute__((naked,noinline)) sub_FF86822C_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    ADD     R5, R4, #0x1C \n"
