...
"    LDR     R0, [R5, #0x28] \n"
"    CMP     R0, #0 \n"
"    BLNE    sub_FF977D70_my \n"  // --> Patched. Old value = 0xFF977D70.
"    B       loc_FF87F458 \n"

"loc_FF87F2E4:\n"
"    LDR     R0, [R0, #0x10] \n"
"    BL      sub_FF977BEC_my \n"  // --> Patched. Old value = 0xFF977BEC.
"    B       loc_FF87F458 \n"
...
/*************************************************************/
//** sub_FF977D70_my @ 0xFF977D70 - 0xFF977DFC, length=36
void __attribute__((naked,noinline)) sub_FF977D70_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    BL      sub_FF87E8E0 \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF977BEC_my @ 0xFF977BEC - 0xFF977D6C, length=97
void __attribute__((naked,noinline)) sub_FF977BEC_my() {
asm volatile (
"    STMFD   SP!, {R2-R6,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, =0x6FB4 \n"
...
"    STR     R3, [SP] \n"
"    LDR     R2, =0x3A98 \n"
"    LDR     R3, =0xFF977E94 /*'SsCaptureCtrl.c'*/ \n"
"    MOV     R1, #0x1000 \n"
"    BL      sub_FF8848B0 \n"
...
"    TST     R0, #1 \n"
"    MOVNE   R1, #0xDF \n"
"    LDRNE   R0, =0xFF977E94 /*'SsCaptureCtrl.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #4] \n"
"    CMP     R0, #0 \n"
"    BNE     loc_FF977D10 \n"
...
/*************************************************************/
//** sub_FFA96F90_my @ 0xFFA96F90 - 0xFFA97010, length=33
void __attribute__((naked,noinline)) sub_FFA96F90_my() {
asm volatile (
"    STMFD   SP!, {R2-R8,LR} \n"
"    MOV     R4, R0 \n"
"    BL      sub_FFA96BEC \n"
...
"    TST     R0, #1 \n"
"    MOVNE   R1, #0x170 \n"
"    LDRNE   R0, =0xFFA971F4 /*'SsStandardCaptureSeq.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #4] \n"
"    AND     R0, R0, #0xFF00 \n"
"    CMP     R0, #0x600 \n"
...
"    BL      sub_FF8AEB60 \n"
"    MOV     R0, R4 \n"
"    BL      sub_FFA96CF8_my \n"  // --> Patched. Old value = 0xFFA96CF8.
"    LDR     PC, =0xFFA97014 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FFA96CF8_my @ 0xFFA96CF8 - 0xFFA96D90, length=39
void __attribute__((naked,noinline)) sub_FFA96CF8_my() {
asm volatile (
"    STMFD   SP!, {R1-R7,LR} \n"
"    LDR     R5, =0x38DE8 \n"
"    LDR     R6, =0x38C18 \n"
...
"    TST     R0, #1 \n"
"    LDRNE   R1, =0x2E5 \n"
"    LDRNE   R0, =0xFFA96BC4 /*'SsCaptureCommon.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDRSH   R0, [R5, #0xC] \n"
"    LDRSH   R1, [SP, #8] \n"
"    BL      sub_FF8F988C \n"
