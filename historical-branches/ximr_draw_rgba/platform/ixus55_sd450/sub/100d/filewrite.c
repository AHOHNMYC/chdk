...
/*************************************************************/
//** filewritetask @ 0xFF866A2C - 0xFF866AB8, length=36
...
/*************************************************************/
//** sub_FF866974_my @ 0xFF866974 - 0xFF866A10, length=40
void __attribute__((naked,noinline)) sub_FF866974_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R2, =0x1CB28 \n"
"    LDRH    R3, [R2] \n"
...
/*************************************************************/
//** sub_FF866820_my @ 0xFF866820 - 0xFF8668B8, length=39
void __attribute__((naked,noinline)) sub_FF866820_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    ADD     R5, R4, #0x1C \n"
