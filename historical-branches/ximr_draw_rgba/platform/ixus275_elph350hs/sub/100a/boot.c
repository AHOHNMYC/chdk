...
void __attribute__((naked,noinline)) sub_FF0203C4_my() {
   ...
   // Replacement of sub_FF02BBF4 for correct power-on.
   // (ON/OFF short press = playback mode, long press = record mode)
   // value and pointer from sub_FF0746D8
...
"    STMFD   SP!, {R3,LR} \n"
"    BL      sub_FF0339F0 \n"
"    BL      sub_FF02D1D0 /*_IsNormalCameraMode_FW*/ \n"
...
/*************************************************************/
//** taskcreatePhySw_my @ 0xFF02BAA0 - 0xFF02BAE4, length=18
void __attribute__((naked,noinline)) taskcreatePhySw_my() {
asm volatile (
"    STMFD   SP!, {R3-R5,LR} \n"
"    BL      sub_FF03683C \n"
"    BL      sub_FF02D108 /*_IsFactoryMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    BLEQ    sub_FF0367A4 /*_OpLog.Start_FW*/ \n"
"    LDR     R4, =0x1CA8 \n"
"    LDR     R0, [R4, #4] \n"
"    CMP     R0, #0 \n"
"    BNE     loc_FF02BAE4 \n"
...
/*************************************************************/
//** init_file_modules_task @ 0xFF060A90 - 0xFF060AC4, length=14
