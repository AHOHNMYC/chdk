...
/*************************************************************/
//** filewritetask @ 0xFF867670 - 0xFF867700, length=37
...
"loc_FF8676A0:\n"
"    BL      sub_FF8675B8_my \n"  // --> Patched. Old value = 0xFF8675B8.

"loc_FF8676A4:\n"
"    MOV     R1, #7 \n"
"    LDR     R0, [R4] \n"
"    MOV     R2, #0 \n"
"    BL      sub_FF81FD4C /*_WaitForAnyEventFlag*/ \n"
"    CMP     R0, #0 \n"
"    MOV     R1, SP \n"
"    BEQ     loc_FF8676D4 \n"
"    MOV     R1, #0x2B0 \n"
"    LDR     R0, =0xFF86750C /*'dwFWrite.c'*/ \n"
"    ADD     R1, R1, #1 \n"
"    BL      _DebugAssert \n"
"    B       loc_FF8676EC \n"
...
"loc_FF8676D4:\n"
"    LDR     R0, [R4] \n"
"    BL      sub_FF81FF58 /*_GetEventFlagValue*/ \n"
"    LDR     R3, [SP] \n"
"    TST     R3, #2 \n"
"    MOV     R1, #5 \n"
"    BEQ     loc_FF867680 \n"
...
/*************************************************************/
//** sub_FF8675B8_my @ 0xFF8675B8 - 0xFF867654, length=40
void __attribute__((naked,noinline)) sub_FF8675B8_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R2, =0x19DA8 \n"
"    LDRH    R3, [R2] \n"
...
/*************************************************************/
//** sub_FF867464_my @ 0xFF867464 - 0xFF8674FC, length=39
void __attribute__((naked,noinline)) sub_FF867464_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    ADD     R5, R4, #0x1C \n"
