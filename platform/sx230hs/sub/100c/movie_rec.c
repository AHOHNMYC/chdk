...
"loc_FF18D91C:\n"
"    LDR     R1, [SP, #4] \n"
"    LDR     R3, =0xFF18B630 /*'MovieRecorder.c'*/ \n"
"    STR     R5, [R1] \n"
"    STR     R9, [SP] \n"
"    LDR     R0, [R4, #0x28] \n"
"    MOV     R2, R10 \n"
...
"loc_FF18CE5C:\n"
"    MOV     R1, #0x3E8 \n"
"    BL      sub_FF3B61A8 /*__divmod_unsigned_int*/ \n"
"    STR     R0, [R6, #0x48] \n"
...
"loc_FF18CEC4:\n"
"    LDR     R1, =0x777 \n"
"    LDR     R0, =0xFF18B630 /*'MovieRecorder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    LDREQ   R1, =0x32A \n"
"    LDREQ   R0, =0xFF3041A8 /*'MovWriter.c'*/ \n"
"    MOV     R5, #0 \n"
"    MOV     R4, R2 \n"
"    MOV     R9, R3 \n"
"    MOV     R6, R5 \n"
