...
/*************************************************************/
//** filewritetask @ 0xF840EC68 - 0xF840EE08, length=105
...
"    CMP     R0, #0 \n"
"    MOVNE   R1, #0x3EC \n"
"    LDRNE   R0, =0xF840EE34 /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xD \n"
...
"loc_F840ED70:\n"
"    BL      sub_F840E954_my \n"  // --> Patched. Old value = 0xF840E954. Open stage
"    B       loc_F840EC74 \n"
...
"loc_F840EDFC:\n"
"    BL      sub_F840F010_my \n"  // --> Patched. Old value = 0xF840F010. Write stage
"    B       loc_F840EC74 \n"

"loc_F840EE04:\n"
"    BL      sub_F840EAE0_my \n"  // --> Patched. Old value = 0xF840EAE0. Close stage
"    B       loc_F840EC74 \n"
);
}

/*************************************************************/
//** sub_F840E954_my @ 0xF840E954 - 0xF840EADC, length=99
void __attribute__((naked,noinline)) sub_F840E954_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_F840F010_my @ 0xF840F010 - 0xF840F0EC, length=56
void __attribute__((naked,noinline)) sub_F840F010_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    ADD     R8, R8, R0 \n"
"    MOVCS   R1, #0x36C \n"
"    LDRCS   R0, =0xF840EE34 /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_F840F05C \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_F840EAE0_my @ 0xF840EAE0 - 0xF840EB20, length=17
void __attribute__((naked,noinline)) sub_F840EAE0_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
