...
/*************************************************************/
//** filewritetask @ 0xF840EC4C - 0xF840EDEC, length=105
...
"    CMP     R0, #0 \n"
"    MOVNE   R1, #0x3EC \n"
"    LDRNE   R0, =0xF840EE18 /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xD \n"
...
"loc_F840ED54:\n"
"    BL      sub_F840E938_my \n"  // --> Patched. Old value = 0xF840E938. Open stage
"    B       loc_F840EC58 \n"
...
"loc_F840EDE0:\n"
"    BL      sub_F840EFF4_my \n"  // --> Patched. Old value = 0xF840EFF4. Write stage
"    B       loc_F840EC58 \n"

"loc_F840EDE8:\n"
"    BL      sub_F840EAC4_my \n"  // --> Patched. Old value = 0xF840EAC4. Close stage
"    B       loc_F840EC58 \n"
);
}

/*************************************************************/
//** sub_F840E938_my @ 0xF840E938 - 0xF840EAC0, length=99
void __attribute__((naked,noinline)) sub_F840E938_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_F840EFF4_my @ 0xF840EFF4 - 0xF840F0D0, length=56
void __attribute__((naked,noinline)) sub_F840EFF4_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    ADD     R8, R8, R0 \n"
"    MOVCS   R1, #0x36C \n"
"    LDRCS   R0, =0xF840EE18 /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_F840F040 \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_F840EAC4_my @ 0xF840EAC4 - 0xF840EB04, length=17
void __attribute__((naked,noinline)) sub_F840EAC4_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
