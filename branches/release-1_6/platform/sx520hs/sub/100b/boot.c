...
void __attribute__((naked,noinline)) sub_FF0203C4_my() {
    ...
    *(int*)(0x2cf0+0x8) = (*(int*)0xc022f48c) & 0x80000 ? 0x400000 : 0x200000;
...
/*************************************************************/
//** init_file_modules_task @ 0xFF061C60 - 0xFF061C94, length=14
...
/*************************************************************/
//** JogDial_task_my @ 0xFF07487C - 0xFF074B9C, length=201
...
"    CMP     R0, #0 \n"
"    LDRNE   R2, =0x229 \n"
"    LDRNE   R1, =0xFF074B48 /*'RotaryEncoder.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #4] \n"
"    AND     R4, R0, #0xFF \n"
...
"    CMP     R0, #0 \n"
"    LDREQ   R2, =0x296 \n"
"    LDREQ   R1, =0xFF074B48 /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
...
"loc_FF074AE0:\n"
"    LDR     R1, =0xFF074B48 /*'RotaryEncoder.c'*/ \n"
"    MOV     R0, #0 \n"
"    BL      _DebugAssert \n"
