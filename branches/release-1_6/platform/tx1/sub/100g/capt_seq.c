...
/*************************************************************/
//** capt_seq_task @ 0xFFB2B704 - 0xFFB2B8D8, length=118
...
"loc_FFB2B87C:\n"
"    LDR     R0, =0xFFB2ABD8 /*'SsShootTask.c'*/ \n"
"    MOV     R1, #0x4D0 \n"
"    BL      _DebugAssert \n"
...
/*************************************************************/
//** sub_FFB2B0D4_my @ 0xFFB2B0D4 - 0xFFB2B32C, length=151
void __attribute__((naked,noinline)) sub_FFB2B0D4_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R1, =0xB6FE0 \n"
"    LDR     R4, [R0, #0xC] \n"
...
/*************************************************************/
//** sub_FFB2E6FC_my @ 0xFFB2E6FC - 0xFFB2E754, length=23
void __attribute__((naked,noinline)) sub_FFB2E6FC_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    MOV     R4, R0 \n"
"    SUB     SP, SP, #0xC \n"
"    BL      sub_FFB2F1C0 \n"
"    MVN     R1, #0 \n"
"    BL      sub_FFB40348 /*_ClearEventFlag*/ \n"
"    MOV     R0, #0x8A \n"
"    ADD     R1, SP, #4 \n"
"    MOV     R2, #4 \n"
"    BL      _GetPropertyCase \n"
...
"    BEQ     loc_FFB2E73C \n"
"    MOV     R1, #0x1D0 \n"
"    LDR     R0, =0xFFB2E580 /*'SsCaptureSeq.c'*/ \n"
"    ADD     R1, R1, #2 \n"
"    BL      _DebugAssert \n"
...
"    MOV     R1, #2 \n"
"    ADD     R2, R2, #8 \n"
"    BL      sub_FFB4019C /*_WaitForAllEventFlag*/ \n"
"    TST     R0, #1 \n"
"    BEQ     loc_FF979D40 \n"
"    MOV     R1, #0x4A0 \n"
