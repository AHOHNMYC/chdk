...
static void gui_calendar_initial_draw() {
    ...
    draw_txt_string((camera_info.ts_button_border/FONT_WIDTH)+1, 0, lang_str(LANG_CALENDAR_TODAY), MAKE_COLOR(SCREEN_COLOR, COLOR_WHITE));
...
void gui_calendar_draw(int enforce_redraw) {
    ...
    draw_txt_string((camera_info.ts_button_border/FONT_WIDTH)+8, 0, str, MAKE_COLOR(SCREEN_COLOR, COLOR_WHITE));
