...
"    STMFD   SP!, {R3,LR} \n"
"    BL      sub_FF033B34 \n"
"    BL      sub_FF02D588 /*_IsNormalCameraMode_FW*/ \n"
...
/*************************************************************/
//** taskcreatePhySw_my @ 0xFF02BE54 - 0xFF02BE98, length=18
void __attribute__((naked,noinline)) taskcreatePhySw_my() {
asm volatile (
"    STMFD   SP!, {R3-R5,LR} \n"
"    BL      sub_FF036984 \n"
"    BL      sub_FF02D4C0 /*_IsFactoryMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    BLEQ    sub_FF0368EC /*_OpLog.Start_FW*/ \n"
"    LDR     R4, =0x1C18 \n"
"    LDR     R0, [R4, #4] \n"
"    CMP     R0, #0 \n"
"    BNE     loc_FF02BE98 \n"
...
/*************************************************************/
//** init_file_modules_task @ 0xFF05E6D8 - 0xFF05E714, length=16
...
/*************************************************************/
//** kbd_p1_f_cont_my @ 0xFF02C394 - 0xFF02C3D4, length=17
...
"    MOV     R0, SP \n"
"    SUB     R1, R2, #0xC \n"
"    BL      sub_FF02BBB0_my \n"  // --> Patched. Old value = 0xFF02BBB0.
"    LDR     PC, =0xFF02C3D8 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF02BBB0_my @ 0xFF02BBB0 - 0xFF02BBB8, length=3
void __attribute__((naked,noinline)) sub_FF02BBB0_my() {
asm volatile (
"    STMFD   SP!, {R0-R12,LR} \n"
"    MOV     R5, R0 \n"
