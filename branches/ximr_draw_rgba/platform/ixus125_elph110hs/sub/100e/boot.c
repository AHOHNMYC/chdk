...
"    MOV     R0, #0x280 \n"
"    STR     R0, [SP, #0x68] \n"
"    LDR     R1, =sub_FF004284_my \n"  // --> Patched. Old value = 0xFF004284.
"    LDR     PC, =0xFF001280 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF004284_my @ 0xFF004284 - 0xFF0042F8, length=30
...
"    BL      sub_FF0053A8 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004398 /*'dmSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF003EBC \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0043A0 /*'termDriverInit'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF0043B0 /*'/_term'*/ \n"
"    BL      sub_FF003FA4 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0043B8 /*'termDeviceCreate'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF0043B0 /*'/_term'*/ \n"
"    BL      sub_FF0029C4 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0043CC /*'stdioSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF004D44 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0043D8 /*'stdlibSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF0016C4 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0043E4 /*'armlib_setup'*/ \n"
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
"    B       sub_FF00B198_my \n"  // --> Patched. Old value = 0xFF00B198.
);
}

/*************************************************************/
//** sub_FF00B198_my @ 0xFF00B198 - 0xFF00B1A8, length=5
void __attribute__((naked,noinline)) sub_FF00B198_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
//"  BL      _sub_FF049BE8 \n"  // --> Nullsub call removed.
"    BL      taskcreate_Startup_my \n"  // --> Patched. Old value = 0xFF00B1AC.
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R4,PC} \n"
);
}
...
/*************************************************************/
//** taskcreate_Startup_my @ 0xFF00B1AC - 0xFF00B270, length=50
...
"    MOVS    R6, R0 \n"
"    BNE     loc_FF00B204 \n"
"    BL      sub_FF01FFE0 /*_IsNormalCameraMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    BEQ     loc_FF00B204 \n"
"    MOV     R0, #0x37 \n"
"    BL      sub_FF024518 \n"
...
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF00B130.
"    LDR     PC, =0xFF00B25C \n"  // Continue in firmware
);
}

/*************************************************************/
//** task_Startup_my @ 0xFF00B130 - 0xFF00B188, length=23
...
"    BL      taskcreatePhySw_my \n"  // --> Patched. Old value = 0xFF01E438.
"    LDR     PC, =0xFF00B168 \n"  // Continue in firmware
);
}

/*************************************************************/
//** taskcreatePhySw_my @ 0xFF01E438 - 0xFF01E458, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFF084030 - 0xFF08404C, length=8
