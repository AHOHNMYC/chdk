...
while true do
    ...
    print(string.format("          sunset: %02d:%02d clock",sunrise/1000, sunrise%1000*600/100/100))
    print(string.format("         sun top: %02d:%02d clock",suntop/1000, suntop%1000*600/100/100))
    print(string.format("         sunrise: %02d:%02d clock",sunset/1000, sunset%1000*600/100/100))
    print(string.format("      civil dust: %02d:%02d clock",dusk/1000, dusk%1000*600/100/100))
    print(line)
