...
"branchtable_fc27bd82:\n"
"    .byte((loc_fc27bdb6 - branchtable_fc27bd82) / 2)\n" // (case 0)
"    .byte((loc_fc27bdb6 - branchtable_fc27bd82) / 2)\n" // (case 1)
"    .byte((loc_fc27bdbc - branchtable_fc27bd82) / 2)\n" // (case 2)
"    .byte((loc_fc27bdc2 - branchtable_fc27bd82) / 2)\n" // (case 3)
"    .byte((loc_fc27bdc2 - branchtable_fc27bd82) / 2)\n" // (case 4)
"    .byte((loc_fc27bdc2 - branchtable_fc27bd82) / 2)\n" // (case 5)
"    .byte((loc_fc27bdb6 - branchtable_fc27bd82) / 2)\n" // (case 6)
"    .byte((loc_fc27bdbc - branchtable_fc27bd82) / 2)\n" // (case 7)
"    .byte((loc_fc27bdc2 - branchtable_fc27bd82) / 2)\n" // (case 8)
"    .byte((loc_fc27bdc2 - branchtable_fc27bd82) / 2)\n" // (case 9)
"    .byte((loc_fc27bdd4 - branchtable_fc27bd82) / 2)\n" // (case 10)
"    .byte((loc_fc27bdd4 - branchtable_fc27bd82) / 2)\n" // (case 11)
"    .byte((loc_fc27bdd4 - branchtable_fc27bd82) / 2)\n" // (case 12)
"    .byte((loc_fc27bea8 - branchtable_fc27bd82) / 2)\n" // (case 13)
"    .byte((loc_fc27beae - branchtable_fc27bd82) / 2)\n" // (case 14)
"    .byte((loc_fc27beae - branchtable_fc27bd82) / 2)\n" // (case 15)
"    .byte((loc_fc27beae - branchtable_fc27bd82) / 2)\n" // (case 16)
"    .byte((loc_fc27beae - branchtable_fc27bd82) / 2)\n" // (case 17)
"    .byte((loc_fc27beb4 - branchtable_fc27bd82) / 2)\n" // (case 18)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 19)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 20)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 21)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 22)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 23)
...
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 25)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 26)
"    .byte((loc_fc27bdc8 - branchtable_fc27bd82) / 2)\n" // (case 27)
"    .byte((loc_fc27bdce - branchtable_fc27bd82) / 2)\n" // (case 28)
"    .byte((loc_fc27bdce - branchtable_fc27bd82) / 2)\n" // (case 29)
"    .byte((loc_fc27bdce - branchtable_fc27bd82) / 2)\n" // (case 30)
"    .byte((loc_fc27bddc - branchtable_fc27bd82) / 2)\n" // (case 31)
"    .byte((loc_fc27bddc - branchtable_fc27bd82) / 2)\n" // (case 32)
"    .byte((loc_fc27bddc - branchtable_fc27bd82) / 2)\n" // (case 33)
"    .byte((loc_fc27bddc - branchtable_fc27bd82) / 2)\n" // (case 34)
"    .byte((loc_fc27bddc - branchtable_fc27bd82) / 2)\n" // (case 35)
"    .byte((loc_fc27bddc - branchtable_fc27bd82) / 2)\n" // (case 36)
"    .byte((loc_fc27bde2 - branchtable_fc27bd82) / 2)\n" // (case 37)
"    .byte((loc_fc27be0c - branchtable_fc27bd82) / 2)\n" // (case 38)
"    .byte((loc_fc27be36 - branchtable_fc27bd82) / 2)\n" // (case 39)
"    .byte((loc_fc27be3a - branchtable_fc27bd82) / 2)\n" // (case 40)
"    .byte((loc_fc27be42 - branchtable_fc27bd82) / 2)\n" // (case 41)
"    .byte((loc_fc27be6c - branchtable_fc27bd82) / 2)\n" // (case 42)
"    .byte((loc_fc27be96 - branchtable_fc27bd82) / 2)\n" // (case 43)
"    .byte((loc_fc27be96 - branchtable_fc27bd82) / 2)\n" // (case 44)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 45)
"    .byte((loc_fc27beb8 - branchtable_fc27bd82) / 2)\n" // (case 46)
"    .byte((loc_fc27be9c - branchtable_fc27bd82) / 2)\n" // (case 47)
"    .byte((loc_fc27be9c - branchtable_fc27bd82) / 2)\n" // (case 48)
"    .byte((loc_fc27be9c - branchtable_fc27bd82) / 2)\n" // (case 49)
"    .byte((loc_fc27bea2 - branchtable_fc27bd82) / 2)\n" // (case 50)
".align 1\n"
"loc_fc27bdb6:\n"
"    bl      sub_fc277ea4\n"
"loc_fc27bdba:\n"
...
void __attribute__((naked,noinline)) sub_fc278b1c_my() {
    asm volatile ( // capdis -stubs -s=0xFC278B1D -c=52 -jfw -f=chdk PRIMARY.BIN 0xfc000000
