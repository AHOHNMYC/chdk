...
/*************************************************************/
//** filewritetask @ 0xFFAE0B18 - 0xFFAE0CE0, length=115
...
"    CMP     R0, #0 \n"
"    LDRNE   R2, =0x409 \n"
"    LDRNE   R1, =0xFFAE0D0C /*'dwFWrite.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
...
"    LDR     R0, [R4, #0x10] \n"
"    MOV     R1, SP \n"
"    BL      sub_FF82A0A8 /*_GetNumberOfPostedMessages*/ \n"
"    LDR     R0, [SP] \n"
"    CMP     R0, #0 \n"
"    BEQ     loc_FFAE0BC4 \n"
"    LDR     R0, [R4, #0x10] \n"
...
"loc_FFAE0C48:\n"
"    BL      sub_FFAE07CC_my \n"  // --> Patched. Old value = 0xFFAE07CC. Open stage
"    B       loc_FFAE0B24 \n"
...
"loc_FFAE0CD4:\n"
"    BL      sub_FFAE0F28_my \n"  // --> Patched. Old value = 0xFFAE0F28. Write stage
"    B       loc_FFAE0B24 \n"

"loc_FFAE0CDC:\n"
"    BL      sub_FFAE0984_my \n"  // --> Patched. Old value = 0xFFAE0984. Close stage
"    B       loc_FFAE0B24 \n"
);
}

/*************************************************************/
//** sub_FFAE07CC_my @ 0xFFAE07CC - 0xFFAE0980, length=110
void __attribute__((naked,noinline)) sub_FFAE07CC_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FFAE0F28_my @ 0xFFAE0F28 - 0xFFAE100C, length=58
void __attribute__((naked,noinline)) sub_FFAE0F28_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    LDRCS   R2, =0x389 \n"
"    ADD     R8, R8, R0 \n"
"    LDRCS   R1, =0xFFAE0D0C /*'dwFWrite.c'*/ \n"
"    MOVCS   R0, #0 \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FFAE0F78 \n"
...
/*************************************************************/
//** sub_FFAE0984_my @ 0xFFAE0984 - 0xFFAE09C4, length=17
void __attribute__((naked,noinline)) sub_FFAE0984_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
