...
// in 102B the original function is at FF87249C
   asm volatile (
				"STMFD   SP!, {R4-R8,LR} \n"
				"MOV     R5, R0 \n"
				"LDR     R0, =0x31B8 \n"
...
/*----------------------------------------------------------------------
	...
	Patched jog dial task  at 102B: FF863668 100D: FF86363C
-----------------------------------------------------------------------*/
...
// sub_FF8966E0 ROM FF8966E0 00000044 R . . . . . .
 asm volatile(
	 "STMFD   SP!, {R4,LR}\n"
	 "MOV     R0, #3\n"
//	 "BL      sub_FF87538C\n"	  //__Mounter.c__0
...
// _sub_FF8753B8__Mounter.c__0 ROM FF8753B8 000000D8 R . . . . . .
 asm volatile(
	 	 "STMFD   SP!, {R4-R8,LR}\n"
	 	 "MOV     R8, R0\n"
