...
/*************************************************************/
//** filewritetask @ 0xFF32E7A0 - 0xFF32E8E4, length=82
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x38E \n"
"    LDRNE   R0, =0xFF32E8E4 /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xB \n"
...
"loc_FF32E878:\n"
"    BL      sub_FF32E49C_my \n"  // --> Patched. Old value = 0xFF32E49C. Open stage
"    B       loc_FF32E7AC \n"
...
"loc_FF32E8B4:\n"
"    BL      sub_FF32EADC_my \n"  // --> Patched. Old value = 0xFF32EADC. Write stage
"    B       loc_FF32E7AC \n"

"loc_FF32E8BC:\n"
"    BL      sub_FF32E608_my \n"  // --> Patched. Old value = 0xFF32E608. Close stage
"    B       loc_FF32E7AC \n"
);
}

/*************************************************************/
//** sub_FF32E49C_my @ 0xFF32E49C - 0xFF32E604, length=91
void __attribute__((naked,noinline)) sub_FF32E49C_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    LDR     R6, =0xF19C \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF32EADC_my @ 0xFF32EADC - 0xFF32EBB8, length=56
void __attribute__((naked,noinline)) sub_FF32EADC_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    ADD     R8, R8, R0 \n"
"    MOVCS   R1, #0x308 \n"
"    LDRCS   R0, =0xFF32E8E4 /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FF32EB28 \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_FF32E608_my @ 0xFF32E608 - 0xFF32E79C, length=102
void __attribute__((naked,noinline)) sub_FF32E608_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x50] \n"
...
"    CMP     R0, #0 \n"
"    LDREQ   R1, =0x346 \n"
"    LDREQ   R0, =0xFF32E8E4 /*'dwFWrite.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    LDR     R0, [SP, #0x28] \n"
"    LDR     R1, [R4, #4] \n"
"    ADD     R0, R0, R1 \n"
