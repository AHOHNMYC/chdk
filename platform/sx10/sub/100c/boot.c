...
/*************************************************************/
//** init_file_modules_task @ 0xFF884A4C - 0xFF884A80, length=14
...
/*************************************************************/
//** sub_FF879F9C_my @ 0xFF879F9C - 0xFF879FA0, length=2
void __attribute__((naked,noinline)) sub_FF879F9C_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    BL      sub_FF85AB00_my \n"  // --> Patched. Old value = 0xFF85AB00.
"    LDR     PC, =0xFF879FA4 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF85AB00_my @ 0xFF85AB00 - 0xFF85AB40, length=17
...
"    BL      sub_FF85A600 \n"
"    MOV     R0, R6 \n"
"    BL      sub_FF85A93C_my \n"  // --> Patched. Old value = 0xFF85A93C.
"    LDR     PC, =0xFF85AB44 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF85A93C_my @ 0xFF85A93C - 0xFF85A970, length=14
...
"    LDR     R0, [R4, #0x38] \n"
"    MOV     R1, R6 \n"
"    BL      sub_FF85A6CC_my \n"  // --> Patched. Old value = 0xFF85A6CC.
"    LDR     PC, =0xFF85A974 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF85A6CC_my @ 0xFF85A6CC - 0xFF85A830, length=90
