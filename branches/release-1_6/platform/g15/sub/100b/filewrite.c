...
/*************************************************************/
//** filewritetask @ 0xFF367848 - 0xFF3679E8, length=105
...
"    CMP     R0, #0 \n"
"    MOVNE   R1, #0x3EC \n"
"    LDRNE   R0, =0xFF367A14 /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xD \n"
...
"loc_FF367950:\n"
"    BL      sub_FF367534_my \n"  // --> Patched. Old value = 0xFF367534. Open stage
"    B       loc_FF367854 \n"
...
"loc_FF3679DC:\n"
"    BL      sub_FF367BF0_my \n"  // --> Patched. Old value = 0xFF367BF0. Write stage
"    B       loc_FF367854 \n"

"loc_FF3679E4:\n"
"    BL      sub_FF3676C0_my \n"  // --> Patched. Old value = 0xFF3676C0. Close stage
"    B       loc_FF367854 \n"
);
}

/*************************************************************/
//** sub_FF367534_my @ 0xFF367534 - 0xFF3676BC, length=99
void __attribute__((naked,noinline)) sub_FF367534_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF367BF0_my @ 0xFF367BF0 - 0xFF367CCC, length=56
void __attribute__((naked,noinline)) sub_FF367BF0_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    ADD     R8, R8, R0 \n"
"    MOVCS   R1, #0x36C \n"
"    LDRCS   R0, =0xFF367A14 /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FF367C3C \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_FF3676C0_my @ 0xFF3676C0 - 0xFF367700, length=17
void __attribute__((naked,noinline)) sub_FF3676C0_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
