...
"    BL      sub_FF0054B0 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF00444C /*'dmSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF003F14 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004454 /*'termDriverInit'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF004464 /*'/_term'*/ \n"
"    BL      sub_FF003FFC \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF00446C /*'termDeviceCreate'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF004464 /*'/_term'*/ \n"
"    BL      sub_FF002A1C \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004480 /*'stdioSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF004E4C \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF00448C /*'stdlibSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF0079F0 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004498 /*'posixSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF007AB0 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0044A4 /*'pthreadSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF006920 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0044B4 /*'dhcpc_setup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF0016DC \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF0044C0 /*'armlib_setup'*/ \n"
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
...
"    MOV     R0, #0 \n"
"    BL      sub_FF03AFA4 \n"
"    BL      sub_0068F6B8 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF00CFD4.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF00D130 /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R3-R7,PC} \n"
);
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x2B3 \n"
"    LDRNE   R0, =0xFF069CD0 /*'TouchPanelDriver_AD7879.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [R5, #0x30] \n"
"    MOV     R1, SP \n"
