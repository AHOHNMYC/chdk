...
void __attribute__((naked,noinline)) sub_FF8203C4_my() {
   ...
   // ON/OFF switch state read at 0xFF82BA98
   // value and pointer from sub_FF867FD8
   *(int*)(0x29bc + 4) = (*(int*)0xC022F48C)&0x100000 ? 0x200000 : 0x100000;
...
/*************************************************************/
//** init_file_modules_task @ 0xFF857C38 - 0xFF857C6C, length=14
