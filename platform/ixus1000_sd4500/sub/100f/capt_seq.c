...
//TIL HERE ixus1000 then changes a lot !!!
	...
	//100F
    // "BLNE    sub_FF98ADD8\n"  // This is a potential my sub  like the FF972EFC but starting some line earlier
	 "BLNE    sub_FF98ADD8_my\n"  // This is a potential my sub  like the FF972EFC but starting some line earlier
						//---------------->
//     "BL      capt_seq_hook_raw_here\n"      // +
//Here no raw is developed
	"B       loc_FF883874\n"
"loc_FF883718:\n"
	"LDRH    R1, [R4]\n"
	"SUB     R12, R1, #0x8200\n"
	...
	// Needs patch too
	//"BLNE    sub_FF98AB6C\n"  // 100 D was 68
	"BLNE    sub_FF98AB6C_my\n"  // 100 D was 68
							//---------------->
//Testing this was enabled erlier as1989
//Here the raw is developed without green?
//     "BL      capt_seq_hook_raw_here\n"      // +
...
void __attribute__((naked,noinline)) sub_FF98ADD8_my() {
	asm volatile (
		"STMFD   SP!, {R4-R6,LR}\n"
		"BL      sub_FF882E6C\n"
		"MOV     R4, R0\n"
...
"loc_FF98AE1C:\n"
		...
		"BL      sub_FFAE37D0_my\n"
			//---------------->
//testing it was enabled eriler asm1989
//No raw file if here
//		"BL      capt_seq_hook_raw_here\n"		// added
		"TST     R0, #1\n"
		"TST     R0, #1\n"
...
void __attribute__((naked,noinline)) sub_FFAE37D0_my() {
	asm volatile (
		"STMFD   SP!, {R2-R8,LR}\n"
		"MOV     R6, R0\n"
		"BL      sub_FF98B928\n"
...
"		MOV	R1, #4\n"
"		BL	sub_FF888CF4\n"
//-TESTed down here with the same results
"		CMP	R0, #0\n"
"		MOVNE	R1, #0x244\n"
"		LDRNE	R0,  =0xFFAE39B4\n" //aSsstandardcaptureseq_c
"		BLNE	sub_FF81EB78\n"  //DebugAssert
...
void __attribute__((naked,noinline)) sub_FFAE3308_my() {
	asm volatile (
				"STMFD   SP!, {R0-R8,LR}\n"
				"MOV     R4, R0\n"
				"MOV     R0, #0\n"
...
void __attribute__((naked,noinline)) sub_FF98AB6C_my() {
	asm volatile (
			"STMFD   SP!, {R3-R7,LR}\n"
			"LDR     R5, =0x3C5E4\n"
			"MOV     R4, R0\n"
...
"loc_FF98ADA8:\n"
		    ...
		    "BL      sub_FFAE37D0_my\n"
					//---------------->
//ASM1989 testing
//Raw is developed but with no green in it.
//			"BL      capt_seq_hook_raw_here\n"		// added
"loc_FF98ADB0:\n"
			"MOV     R7, R0\n"
			"B       loc_FF98ADC8\n"
