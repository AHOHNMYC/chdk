...
"    MUL     R0, R1, R0 \n"
"    LDR     R1, [R5, #0x48] \n"
"    BL      sub_FFAD7288 /*__divmod_unsigned_int*/ \n"
"    MOV     R4, R0 \n"
"    BL      sub_FFA40114 \n"
"    LDR     R1, [R5, #0x80] \n"
"    CMP     R1, R4 \n"
...
/*************************************************************/
//** sub_FFA3DCA8_my @ 0xFFA3DCA8 - 0xFFA3DD88, length=57
void __attribute__((naked,noinline)) sub_FFA3DCA8_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    LDR     R4, =0x97F0 \n"
"    LDR     LR, [R4] \n"
