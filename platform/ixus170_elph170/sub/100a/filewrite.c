...
/*************************************************************/
//** filewritetask @ 0xFFAB1DFC - 0xFFAB1FC4, length=115
...
"    CMP     R0, #0 \n"
"    LDRNE   R2, =0x409 \n"
"    LDRNE   R1, =0xFFAB1FF0 /*'dwFWrite.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
...
"loc_FFAB1F2C:\n"
"    BL      sub_FFAB1AB0_my \n"  // --> Patched. Old value = 0xFFAB1AB0. Open stage
"    B       loc_FFAB1E08 \n"
...
"loc_FFAB1FB8:\n"
"    BL      sub_FFAB220C_my \n"  // --> Patched. Old value = 0xFFAB220C. Write stage
"    B       loc_FFAB1E08 \n"

"loc_FFAB1FC0:\n"
"    BL      sub_FFAB1C68_my \n"  // --> Patched. Old value = 0xFFAB1C68. Close stage
"    B       loc_FFAB1E08 \n"
);
}

/*************************************************************/
//** sub_FFAB1AB0_my @ 0xFFAB1AB0 - 0xFFAB1C64, length=110
void __attribute__((naked,noinline)) sub_FFAB1AB0_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FFAB220C_my @ 0xFFAB220C - 0xFFAB22F0, length=58
void __attribute__((naked,noinline)) sub_FFAB220C_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    LDRCS   R2, =0x389 \n"
"    ADD     R8, R8, R0 \n"
"    LDRCS   R1, =0xFFAB1FF0 /*'dwFWrite.c'*/ \n"
"    MOVCS   R0, #0 \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FFAB225C \n"
...
/*************************************************************/
//** sub_FFAB1C68_my @ 0xFFAB1C68 - 0xFFAB1CA8, length=17
void __attribute__((naked,noinline)) sub_FFAB1C68_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
