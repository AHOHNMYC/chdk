...
/*************************************************************/
//** filewritetask @ 0xFF3399B0 - 0xFF339B50, length=105
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x3EF \n"
"    LDRNE   R0, =0xFF339B7C /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xD \n"
...
"loc_FF339AB8:\n"
"    BL      sub_FF33969C_my \n"  // --> Patched. Old value = 0xFF33969C. Open stage
"    B       loc_FF3399BC \n"
...
"loc_FF339B44:\n"
"    BL      sub_FF339D5C_my \n"  // --> Patched. Old value = 0xFF339D5C. Write stage
"    B       loc_FF3399BC \n"

"loc_FF339B4C:\n"
"    BL      sub_FF339828_my \n"  // --> Patched. Old value = 0xFF339828. Close stage
"    B       loc_FF3399BC \n"
);
}

/*************************************************************/
//** sub_FF33969C_my @ 0xFF33969C - 0xFF339824, length=99
void __attribute__((naked,noinline)) sub_FF33969C_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF339D5C_my @ 0xFF339D5C - 0xFF339E38, length=56
void __attribute__((naked,noinline)) sub_FF339D5C_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    LDRCS   R1, =0x36F \n"
"    ADD     R8, R8, R0 \n"
"    LDRCS   R0, =0xFF339B7C /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FF339DA8 \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_FF339828_my @ 0xFF339828 - 0xFF339868, length=17
void __attribute__((naked,noinline)) sub_FF339828_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
