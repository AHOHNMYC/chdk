...
#define LED_AC	0xC0220130	// green, activity (back)
#define LED_AF	0xC02200AC	// orange, autofocus (front)
	
static void __attribute__((noreturn)) shutdown() {
	
    volatile long *p = (void*)LED_AC;       // turned off later
