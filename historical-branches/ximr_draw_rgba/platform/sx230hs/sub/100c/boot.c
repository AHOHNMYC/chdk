...
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
"    B       taskcreate_Startup_my \n"  // --> Patched. Old value = 0xFF00FD4C.
);
}

/*************************************************************/
//** taskcreate_Startup_my @ 0xFF00FD4C - 0xFF00FD78, length=12
void __attribute__((naked,noinline)) taskcreate_Startup_my() {
asm volatile (
"    STMFD   SP!, {R3,LR} \n"
"    BL      sub_FF02B744 \n"
"    BL      sub_FF02B95C /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =sub_FF00FC64_my \n"  // --> Patched. Old value = 0xFF00FC64.
"    MOV     R2, #0x200 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF00FD98 /*'Booting'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R3,PC} \n"
);
...
/*************************************************************/
//** sub_FF00FC64_my @ 0xFF00FC64 - 0xFF00FD48, length=58
void __attribute__((naked,noinline)) sub_FF00FC64_my() {
asm volatile (
"    STMFD   SP!, {R3-R9,LR} \n"
"    MOV     R5, #0 \n"
...
"    MOV     R8, #1 \n"
"    BNE     loc_FF00FCF8 \n"
"    BL      sub_FF0263B8 /*_IsNormalCameraMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    BEQ     loc_FF00FCF8 \n"
"    LDR     R0, [R7, #0xD4] \n"
"    BICS    R4, R8, R0 \n"
...
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF00FBEC.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF00FD8C /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    LDMFD   SP!, {R3-R9,PC} \n"
);
}
...
/*************************************************************/
//** task_Startup_my @ 0xFF00FBEC - 0xFF00FC44, length=23
...
"    BL      sub_FF02D92C \n"
"    BL      sub_FF02AEE8 \n"
"    BL      sub_FF02DAB0_my \n"  // --> Patched. Old value = 0xFF02DAB0.

"    BL      CreateTask_spytask\n"  // added

"    BL      taskcreatePhySw_my \n"  // --> Patched. Old value = 0xFF0248D4.
"    LDR     PC, =0xFF00FC34 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF02DAB0_my @ 0xFF02DAB0 - 0xFF02DAC4, length=6
void __attribute__((naked,noinline)) sub_FF02DAB0_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    BL      sub_FF094204_my \n"  // --> Patched. Old value = 0xFF094204.
"    BL      sub_FF08FAD0 \n"
"    BL      sub_FF090390 \n"
"    LDMFD   SP!, {R4,LR} \n"
"    B       sub_FF093034 \n"
...
/*************************************************************/
//** sub_FF094204_my @ 0xFF094204 - 0xFF094260, length=24
void __attribute__((naked,noinline)) sub_FF094204_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    BL      sub_FF026308 /*_IsFactoryMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    LDR     R4, =0x48D8 \n"
"    LDRNE   R0, =0xFF02BBBC \n"
"    STRNE   R0, [R4, #4] \n"
...
"    MOV     R0, R5 \n"
"    BL      sub_FF02BBC4 /*_malloc_strictly*/ \n"
"    MOV     R1, R5 \n"
"    BL      sub_FF001274 \n"
"    TST     R0, #1 \n"
"    STR     R0, [R4] \n"
...
"    LDMFD   SP!, {R4-R6,LR} \n"
"    MOV     R1, #0x4D \n"
"    LDR     R0, =0xFF094280 /*'UiMemory.c'*/ \n"
"    B       _DebugAssert \n"
);
}

/*************************************************************/
//** taskcreatePhySw_my @ 0xFF0248D4 - 0xFF0248F4, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFF096FD8 - 0xFF096FF4, length=8
...
/*************************************************************/
//** JogDial_task_my @ 0xFF057998 - 0xFF057CC8, length=205
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x236 \n"
"    LDRNE   R0, =0xFF057C50 /*'RotaryEncoder.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP] \n"
"    AND     R4, R0, #0xFF \n"
"    AND     R0, R0, #0xFF00 \n"
...
"    LDR     R0, =0x260C \n"
"    LDR     R0, [R0, R4, LSL#2] \n"
"    BL      sub_FF02C128 /*_CancelTimer*/ \n"
"    LDR     R2, =0xFF0578E4 \n"
"    ORR     R3, R4, #0x200 \n"
"    MOV     R1, R2 \n"
"    MOV     R0, #0x28 \n"
"    BL      sub_FF02C044 /*_SetTimerAfter*/ \n"
"    TST     R0, #1 \n"
"    CMPNE   R0, #0x15 \n"
"    STR     R0, [R10, R4, LSL#2] \n"
"    BEQ     loc_FF0579E8 \n"
...
"loc_FF057BF0:\n"
"    LDR     R0, =0xFF057C50 /*'RotaryEncoder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x2B4 \n"
"    LDREQ   R0, =0xFF057C50 /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
