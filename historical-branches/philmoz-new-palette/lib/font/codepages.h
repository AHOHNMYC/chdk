//
// Input into font_8x16_pack.c tool - used to generate run-time font & codepage data
//
// Values in codepages below are character numbers. These are converted into offsets into the font_data array for CHDK run-time.
// Update this file if new codepages are added.
//

/* Common part */
static unsigned short cp_common[] = {
    0xFFFD, 0x263A, 0x263B, 0x2665, 0x2666, 0x2663, 0x2660, 0x2022, 0x25D8, 0x25CB, 0x25D9, 0x2642, 0x2640, 0x266A, 0x266B, 0x263C,
...
// Note: If new codepages are added, update the cp_names array and codepages array below.

static char *cp_names[] =
{
    "1250",
    "1251",
    "1252",
