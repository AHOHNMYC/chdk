...
void __attribute__((naked,noinline)) sub_FF810354_my() {
    ...
    *(int*)0x1938=(int)taskHook;
    ...
    // replacement of sub_FF85FA6C for correct power-on.
...
/*************************************************************/
//** taskcreatePhySw_my @ 0xFF833224 - 0xFF833244, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFF898F88 - 0xFF898FA4, length=8
...
/*************************************************************/
//** sub_FF88DF7C_my @ 0xFF88DF7C - 0xFF88DF84, length=3
...
/*************************************************************/
//** sub_FF86F8AC_my @ 0xFF86F8AC - 0xFF86F900, length=22
...
/*************************************************************/
//** sub_FF86F4E0_my @ 0xFF86F4E0 - 0xFF86F508, length=11
...
/*************************************************************/
//** sub_FF86F1DC_my @ 0xFF86F1DC - 0xFF86F34C, length=93
...
/*************************************************************/
//** JogDial_task_my @ 0xFF860554 - 0xFF8608A4, length=213
...
"    LDR     R0, [R0, #8] \n"
"    ADD     R1, SP, #4 \n"
"    BL      sub_FF83894C /*_ReceiveMessageQueue*/ \n"
"    TST     R0, #1 \n"
"    LDRNE   R1, =0x226 \n"
"    LDRNE   R0, =0xFF860830 /*'JogDial.c'*/ \n"
"    BLNE    _DebugAssert \n"
//------------------  added code ---------------------
"labelA:\n"
...
"    LDR     R5, =0x25E0 \n"
"    LDR     R0, [R5, R4, LSL#2] \n"
"    BL      sub_FF8398E4 /*_CancelTimer*/ \n"
"    LDR     R2, =0xFF8604E0 \n"
"    MOV     R1, R2 \n"
"    ORR     R3, R4, #0x200 \n"
"    MOV     R0, #0x28 \n"
"    BL      sub_FF839800 /*_SetTimerAfter*/ \n"
"    TST     R0, #1 \n"
"    CMPNE   R0, #0x15 \n"
"    STR     R0, [R10, R4, LSL#2] \n"
"    BEQ     loc_FF8605AC \n"
