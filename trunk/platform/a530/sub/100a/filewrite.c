...
/*************************************************************/
//** filewritetask @ 0xFFC56548 - 0xFFC565D8, length=37
...
/*************************************************************/
//** sub_FFC56490_my @ 0xFFC56490 - 0xFFC5652C, length=40
void __attribute__((naked,noinline)) sub_FFC56490_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R2, =0x198C8 \n"
"    LDRH    R3, [R2] \n"
...
/*************************************************************/
//** sub_FFC5633C_my @ 0xFFC5633C - 0xFFC563D4, length=39
void __attribute__((naked,noinline)) sub_FFC5633C_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    ADD     R5, R4, #0x1C \n"
