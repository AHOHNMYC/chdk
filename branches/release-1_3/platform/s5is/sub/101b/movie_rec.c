...
/*************************************************************/
//** movie_record_task @ 0xFF862E48 - 0xFF862F60, length=71
...
"    STR     R6, [R1] \n"
"    LDR     R0, [R4, #0x1C] \n"
"    BL      sub_FF82A620 /*_PostMessageQueue*/ \n"
"    LDR     R0, [R4, #0xAC] \n"
"    BL      _GiveSemaphore \n"
"    B       loc_FF862E58 \n"
);
...
/*************************************************************/
//** sub_FF862904_my @ 0xFF862904 - 0xFF862AC8, length=114
...
"    BEQ     loc_FF862A44 \n"
"    BL      sub_FF95DEEC \n"
"    LDR     R0, =0xFF8625E0 /*'JPEGICError'*/ \n"
"    STR     R7, [R5, #0x38] \n"

"loc_FF862A3C:\n"
"    BL      sub_FF878128 /*_HardwareDefect_FW*/ \n"
"    B       loc_FF86298C \n"
...
"    MUL     R0, R1, R0 \n"
"    LDR     R1, [R5, #0x74] \n"
"    BL      sub_FFA944C0 /*__divmod_unsigned_int*/ \n"
"    MOV     R4, R0 \n"
"    BL      sub_FF95DF1C \n"
"    LDR     R1, [R5, #0x70] \n"
"    CMP     R1, R4 \n"
...
/*************************************************************/
//** sub_FF95BA54_my @ 0xFF95BA54 - 0xFF95BB38, length=58
