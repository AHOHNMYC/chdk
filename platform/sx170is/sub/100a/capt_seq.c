...
/*************************************************************/
//** sub_FFADA1E0_my @ 0xFFADA1E0 - 0xFFADA264, length=34
...
"    BL      sub_FF8BDC88 \n"
"    MOV     R0, R4 \n"
"    BL      sub_FFAD9EC4_my \n"  // --> Patched. Old value = 0xFFAD9EC4.
"    LDR     PC, =0xFFADA268 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FFAD9EC4_my @ 0xFFAD9EC4 - 0xFFAD9F70, length=44
void __attribute__((naked,noinline)) sub_FFAD9EC4_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    LDR     R6, =0x1D758 \n"
"    MOV     R4, R0 \n"
...
"    BEQ     loc_FFAD9F50 \n"
"    LDR     R2, =0x343 \n"
"    LDR     R1, =0xFFAD9AB4 /*'SsCaptureCommon.c'*/ \n"
"    MOV     R0, #0 \n"
"    BL      _DebugAssert \n"
