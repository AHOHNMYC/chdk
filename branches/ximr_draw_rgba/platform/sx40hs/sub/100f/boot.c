...
"    MOV     R0, #0 \n"
"    BL      sub_FF02BB2C \n"
"    BL      sub_FF02B8D4 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
...
/*************************************************************/
//** JogDial_task_my @ 0xFF057F64 - 0xFF058288, length=202
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x256 \n"
"    LDRNE   R0, =0xFF058214 /*'RotaryEncoder.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP] \n"
"    AND     R4, R0, #0xFF \n"
"    AND     R0, R0, #0xFF00 \n"
...
"    LDR     R0, =0x2658 \n"
"    LDR     R0, [R0, R4, LSL#2] \n"
"    BL      sub_FF02C318 /*_CancelTimer*/ \n"
"    LDR     R2, =0xFF057EB0 \n"
"    ORR     R3, R4, #0x200 \n"
"    MOV     R1, R2 \n"
"    MOV     R0, #0x28 \n"
"    BL      sub_FF02C234 /*_SetTimerAfter*/ \n"
"    TST     R0, #1 \n"
"    CMPNE   R0, #0x15 \n"
"    STR     R0, [R10, R4, LSL#2] \n"
"    BEQ     loc_FF057FB4 \n"
...
"loc_FF0581B4:\n"
"    LDR     R0, =0xFF058214 /*'RotaryEncoder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x2D4 \n"
"    LDREQ   R0, =0xFF058214 /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
