...
"exitHook:\n" // restore overwritten registers
    ...
    // How to find the original CreateTask function:
    // CreateTask RAM address (0x68AB8C) - RAM BASE + ROM-to-RAM start address
    // In this case: 0x68AB8C - 0x00685000 + 0xf896e790 = 0xF8974694
    // Then adjust addresses ROM->RAM
...
"exitHook2:\n"
    ...
    // RAM address (0x68AF04) - RAM BASE + ROM-to-RAM start address
    // In this case: 0x68AF04 - 0x00685000 + 0xf896e790 = 0xF897431C
    // Then adjust addresses ROM->RAM
