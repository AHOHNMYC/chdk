...
void __attribute__((naked,noinline)) sub_FF810354_my() {
    ...
    *(int*)0x1938=(int)taskHook;
    ...
    // replacement of sub_FF85FA1C for correct power-on.
    //(short press = playback mode, long press = record mode)
    *(int*)(0x25C8)= (*(int*)0xC0220108) & 1 ? 0x1000000 : 0x2000000;
...
/*************************************************************/
//** taskcreate_Startup_my @ 0xFF81F868 - 0xFF81F8D8, length=29
...
"    BL      taskcreatePhySw_my \n"  // --> Patched. Old value = 0xFF8331F4.
"    LDR     PC, =0xFF81F838 \n"  // Continue in firmware
);
}

/*************************************************************/
//** taskcreatePhySw_my @ 0xFF8331F4 - 0xFF833214, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFF898EA4 - 0xFF898EC0, length=8
...
/*************************************************************/
//** sub_FF88DEAC_my @ 0xFF88DEAC - 0xFF88DEB4, length=3
void __attribute__((naked,noinline)) sub_FF88DEAC_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    MOV     R0, #3 \n"
"    BL      sub_FF86F85C_my \n"  // --> Patched. Old value = 0xFF86F85C.
"    LDR     PC, =0xFF88DEB8 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF86F85C_my @ 0xFF86F85C - 0xFF86F8B0, length=22
...
"    BL      sub_FF86F10C \n"
"    MOV     R0, R6 \n"
"    BL      sub_FF86F490_my \n"  // --> Patched. Old value = 0xFF86F490.
"    LDR     PC, =0xFF86F8B4 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF86F490_my @ 0xFF86F490 - 0xFF86F4B8, length=11
...
"    LDR     R0, [R4, #0x38] \n"
"    MOV     R1, R5 \n"
"    BL      sub_FF86F18C_my \n"  // --> Patched. Old value = 0xFF86F18C.
"    LDR     PC, =0xFF86F4BC \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF86F18C_my @ 0xFF86F18C - 0xFF86F2FC, length=93
...
/*************************************************************/
//** JogDial_task_my @ 0xFF860504 - 0xFF860854, length=213
...
"    LDR     R5, =0x25E0 \n"
"    LDR     R0, [R5, R4, LSL#2] \n"
"    BL      sub_FF8398B4 /*_CancelTimer*/ \n"
"    LDR     R2, =0xFF860490 \n"
"    MOV     R1, R2 \n"
"    ORR     R3, R4, #0x200 \n"
"    MOV     R0, #0x28 \n"
"    BL      sub_FF8397D0 /*_SetTimerAfter*/ \n"
"    TST     R0, #1 \n"
"    CMPNE   R0, #0x15 \n"
"    STR     R0, [R10, R4, LSL#2] \n"
"    BEQ     loc_FF86055C \n"
