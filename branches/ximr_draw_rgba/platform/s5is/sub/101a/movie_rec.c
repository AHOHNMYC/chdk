...
/*************************************************************/
//** movie_record_task @ 0xFF862F10 - 0xFF863028, length=71
...
"    STR     R6, [R1] \n"
"    LDR     R0, [R4, #0x1C] \n"
"    BL      sub_FF82A6E8 /*_PostMessageQueue*/ \n"
"    LDR     R0, [R4, #0xAC] \n"
"    BL      _GiveSemaphore \n"
"    B       loc_FF862F20 \n"
);
...
/*************************************************************/
//** sub_FF8629CC_my @ 0xFF8629CC - 0xFF862B90, length=114
...
"    BEQ     loc_FF862B0C \n"
"    BL      sub_FF95DFB4 \n"
"    LDR     R0, =0xFF8626A8 /*'JPEGICError'*/ \n"
"    STR     R7, [R5, #0x38] \n"

"loc_FF862B04:\n"
"    BL      sub_FF8781F0 /*_HardwareDefect_FW*/ \n"
"    B       loc_FF862A54 \n"
...
"    MUL     R0, R1, R0 \n"
"    LDR     R1, [R5, #0x74] \n"
"    BL      sub_FFA945B4 /*__divmod_unsigned_int*/ \n"
"    MOV     R4, R0 \n"
"    BL      sub_FF95DFE4 \n"
"    LDR     R1, [R5, #0x70] \n"
"    CMP     R1, R4 \n"
...
/*************************************************************/
//** sub_FF95BB1C_my @ 0xFF95BB1C - 0xFF95BC00, length=58
