...
p-=17;
if (p[0]==0xff8864c0)  p[0]=(int)init_file_modules_task;
if (p[0]==0xff86d6f0)  p[0]=(int)task_CaptSeqTask_my;
if (p[0]==0xff8aa798)  p[0]=(int)exp_drv_task;
if (p[0]==0xff92dbec)  p[0]=(int)movie_record_task;
}
...
void __attribute__((naked,noinline)) sub_FF87E9A4_my() { 
 asm volatile (
