...
/*************************************************************/
//** filewritetask @ 0xFF2C4FE8 - 0xFF2C512C, length=82
...
"loc_FF2C50C0:\n"
"    BL      sub_FF2C4CE4_my \n"  // --> Patched. Old value = 0xFF2C4CE4. Open stage
"    B       loc_FF2C4FF4 \n"
...
"loc_FF2C50FC:\n"
"    BL      sub_FF2C5324_my \n"  // --> Patched. Old value = 0xFF2C5324. Write stage
"    B       loc_FF2C4FF4 \n"

"loc_FF2C5104:\n"
"    BL      sub_FF2C4E50_my \n"  // --> Patched. Old value = 0xFF2C4E50. Close stage
"    B       loc_FF2C4FF4 \n"
);
}

/*************************************************************/
//** sub_FF2C4CE4_my @ 0xFF2C4CE4 - 0xFF2C4E4C, length=91
void __attribute__((naked,noinline)) sub_FF2C4CE4_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    LDR     R6, =0xAF98 \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF2C5324_my @ 0xFF2C5324 - 0xFF2C5400, length=56
void __attribute__((naked,noinline)) sub_FF2C5324_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
/*************************************************************/
//** sub_FF2C4E50_my @ 0xFF2C4E50 - 0xFF2C4FE4, length=102
void __attribute__((naked,noinline)) sub_FF2C4E50_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x50] \n"
