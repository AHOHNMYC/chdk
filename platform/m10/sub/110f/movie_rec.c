...
"    .byte((loc_fc0fe216 - branchtable_fc0fe01a) / 2)\n" // (case 0)
"    .byte((loc_fc0fe04c - branchtable_fc0fe01a) / 2)\n" // (case 1)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 2)
"    .byte((loc_fc0fe030 - branchtable_fc0fe01a) / 2)\n" // (case 3)
"    .byte((loc_fc0fe214 - branchtable_fc0fe01a) / 2)\n" // (case 4)
"    .byte((loc_fc0fe212 - branchtable_fc0fe01a) / 2)\n" // (case 5)
"    .byte((loc_fc0fe15a - branchtable_fc0fe01a) / 2)\n" // (case 6)
"    .byte((loc_fc0fe122 - branchtable_fc0fe01a) / 2)\n" // (case 7)
"    .byte((loc_fc0fe0fe - branchtable_fc0fe01a) / 2)\n" // (case 8)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 9)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 10)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 11)
"    .byte((loc_fc0fe210 - branchtable_fc0fe01a) / 2)\n" // (case 12)
"    .byte((loc_fc0fe20e - branchtable_fc0fe01a) / 2)\n" // (case 13)
"    .byte((loc_fc0fe20c - branchtable_fc0fe01a) / 2)\n" // (case 14)
"    .byte((loc_fc0fe080 - branchtable_fc0fe01a) / 2)\n" // (case 15)
"    .byte((loc_fc0fe0a2 - branchtable_fc0fe01a) / 2)\n" // (case 16)
"    .byte((loc_fc0fe0cc - branchtable_fc0fe01a) / 2)\n" // (case 17)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 18)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 19)
"    .byte((loc_fc0fe0fc - branchtable_fc0fe01a) / 2)\n" // (case 20)
"    .byte((loc_fc0fe188 - branchtable_fc0fe01a) / 2)\n" // (case 21)
".align 1\n"
"loc_fc0fe030:\n"
"    movw    r1, #0x95d\n"
"    strh    r1, [r4, #0x1c]\n"
