...
/*************************************************************/
//** capt_seq_task @ 0xFC07498D, length=197 
...
asm volatile (
            ...
            "    cmp     r0, #0\n"
            "    beq     loc_fc074a34\n"
            "    bl      sub_fc08ec20_my\n" // -> nr?, remote hook, raw hook (quick, no half press) (was sub_fc08ec20)
            "loc_fc074a34:\n"
            "    b       loc_fc074bb6\n"
            "loc_fc074a36:\n"
            "    ldr     r0, [r0, #0x10]\n"
            "    bl      sub_fc08ebd4_my\n" // -> nr?, remote hook, raw hook (was sub_fc08ebd4)
            "    b       loc_fc074bb6\n"
            "loc_fc074a3e:\n"
            "    movs    r0, #1\n"
            "    bl      sub_fc0830ca\n"
...
/*************************************************************/
//** sub_fc08ec20_my @ 0xFC08EC21, length=58 
...
/*************************************************************/
//** sub_fc08ebd4_my @ 0xFC08EBD5, length=33 
...
/*************************************************************/
//** sub_fc08e9e6_my @ 0xFC08E9E7, length=180 
...
/*************************************************************/
//** sub_fc0a009e_my @ 0xFC0A009F, length=249 
...
/*************************************************************/
//** exp_drv_task @ 0xFC2F63D7, length=258 
...
/*************************************************************/
//** sub_fc2f32e2_my @ 0xFC2F32E3, length=53 jfw
...
asm volatile (
            ...
            "    strh    r0, [r4, #0xc]\n"
            "    ldrsh.w r0, [r4, #6]\n"
            "    bl      sub_fc470d06_my\n" // Patched (was sub_fc470d06)
            "    ldr     pc, =0xfc2f3375\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc470d06_my @ 0xFC470D07, length=35 
