...
asm volatile (
            "    movs    r0, #3\n"
            "    push    {r4, lr}\n"
            "    bl      sub_fc3b7134_my\n" // Patched (was sub_fc3b7134)
            "    ldr     pc, =0xfc0c997f\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b7134_my @ 0xFC3B7135, length=26 jfw
void __attribute__((naked,noinline)) sub_fc3b7134_my() {
asm volatile (
            ...
            "    bl      sub_fc3b6aa0\n"
            "    mov     r0, r5\n"
            "    bl      sub_fc3b6d02_my\n" // Patched (was sub_fc3b6d02)
            "    ldr     pc, =0xfc3b717b\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b6d02_my @ 0xFC3B6D03, length=11 jfw
void __attribute__((naked,noinline)) sub_fc3b6d02_my() {
asm volatile (
            "    push    {r4, r5, r6, lr}\n"
            "    mov     r5, r0\n"
            "    ldr     r0, =0x00044368\n"
            ...
            "    ldr     r0, [r4, #0x38]\n"
            "    mov     r1, r5\n"
            "    bl      sub_fc3b6afe_my\n" // Patched (was sub_fc3b6afe)
            "    ldr     pc, =0xfc3b6d1b\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b6afe_my @ 0xFC3B6AFF, length=108 
void __attribute__((naked,noinline)) sub_fc3b6afe_my() {
asm volatile (
            ...
            "branchtable_fc3b6b1c:\n"
            "    .byte((loc_fc3b6b34 - branchtable_fc3b6b1c) / 2)\n" // (case 0)
            "    .byte((loc_fc3b6b24 - branchtable_fc3b6b1c) / 2)\n" // (case 1)
            "    .byte((loc_fc3b6b24 - branchtable_fc3b6b1c) / 2)\n" // (case 2)
            "    .byte((loc_fc3b6b24 - branchtable_fc3b6b1c) / 2)\n" // (case 3)
            "    .byte((loc_fc3b6b24 - branchtable_fc3b6b1c) / 2)\n" // (case 4)
            "    .byte((loc_fc3b6bf4 - branchtable_fc3b6b1c) / 2)\n" // (case 5)
            "    .byte((loc_fc3b6b24 - branchtable_fc3b6b1c) / 2)\n" // (case 6)
            ".align 1\n"
            "loc_fc3b6b24:\n"
            "    movs    r2, #0\n"
...
/*************************************************************/
//** task_TricInitTask_my @ 0xFC542265, length=35 
