...
"loc_FF17FD5C:\n"
"    LDR     R1, [SP, #4] \n"
"    LDR     R3, =0xFF17DA24 /*'MovieRecorder.c'*/ \n"
"    STR     R5, [R1] \n"
"    STR     R9, [SP] \n"
"    LDR     R0, [R4, #0x28] \n"
"    MOV     R2, R10 \n"
"    BL      sub_FF02B750 /*_PostMessageQueueStrictly*/ \n"
"    B       loc_FF17FC20 \n"
);
}
...
"loc_FF17F290:\n"
"    MOV     R1, #0x3E8 \n"
"    BL      sub_FF3CA57C /*__divmod_unsigned_int*/ \n"
"    STR     R0, [R6, #0x48] \n"
...
"loc_FF17F2F8:\n"
"    LDR     R1, =0x777 \n"
"    LDR     R0, =0xFF17DA24 /*'MovieRecorder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    MOVNE   R1, #0 \n"
"    MOVNE   R0, #0xD \n"
"    BLNE    sub_FF08268C /*_exmem_ualloc*/ \n"
"    LDR     R0, [R6, #0x4C] \n"
"    LDR     R5, =0x7198 \n"
"    LDR     R8, =0xB3624 \n"
"    CMP     R0, #2 \n"
...
/*************************************************************/
//** sub_FF303920_my @ 0xFF303920 - 0xFF303CDC, length=240
...
"    CMP     R0, #0 \n"
"    LDREQ   R1, =0x32A \n"
"    LDREQ   R0, =0xFF3028F4 /*'MovWriter.c'*/ \n"
"    MOV     R5, #0 \n"
"    MOV     R4, R2 \n"
"    MOV     R10, R3 \n"
"    MOV     R7, R5 \n"
