...
void __attribute__((naked,noinline)) sub_FF810358_my() {
    ...
    *(int*)0x193C=(int)taskHook;
    ...
    // Replacement of sub_FF85FC9C for correct power-on.
...
"    MOV     R8, #1 \n"
"    BNE     loc_FF81FCC0 \n"
"    BL      sub_FF835BCC /*_IsNormalCameraMode_FW*/ \n"
"    CMP     R0, #0 \n"
"    BEQ     loc_FF81FCC0 \n"
"    LDR     R0, [R9, #0x34] \n"
"    BIC     R5, R8, R0 \n"
...
"    MOV     R0, #0 \n"
"    BL      sub_FF83A610 \n"
"    BL      sub_FF83A3B8 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF81FBF4.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF81FD2C /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R3-R9,PC} \n"
);
...
"    BL      taskcreatePhySw_my \n"  // --> Patched. Old value = 0xFF834190.
"    LDR     PC, =0xFF81FC28 \n"  // Continue in firmware
);
}

/*************************************************************/
//** taskcreatePhySw_my @ 0xFF834190 - 0xFF8341B0, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFF895844 - 0xFF895860, length=8
