...
#endif
/*************************************************************/
// // task_FileWrite 0xfc068b89  -s=task_FileWrite -c=43 -f=chdk
void __attribute__((naked,noinline)) filewritetask() {
asm volatile (
// task_FileWrite 0xfc068b89
...
"branchtable_fc068bb6:\n"
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 0)
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 1)
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 2)
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 3)
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 4)
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 5)
"    .byte((loc_fc068bf8 - branchtable_fc068bb6) / 2)\n" // (case 6)
"    .byte((loc_fc068bfe - branchtable_fc068bb6) / 2)\n" // (case 7)
"    .byte((loc_fc068bc4 - branchtable_fc068bb6) / 2)\n" // (case 8)
"    .byte((loc_fc068bd6 - branchtable_fc068bb6) / 2)\n" // (case 9)
"    .byte((loc_fc068bf2 - branchtable_fc068bb6) / 2)\n" // (case 10)
"    .byte((loc_fc068bca - branchtable_fc068bb6) / 2)\n" // (case 11)
"    .byte((loc_fc068bd0 - branchtable_fc068bb6) / 2)\n" // (case 12)
".align 1\n"
