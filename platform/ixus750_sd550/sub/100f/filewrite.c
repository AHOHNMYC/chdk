...
/*************************************************************/
//** filewritetask @ 0xFF867594 - 0xFF867624, length=37
...
/*************************************************************/
//** sub_FF8674DC_my @ 0xFF8674DC - 0xFF867578, length=40
void __attribute__((naked,noinline)) sub_FF8674DC_my() {
asm volatile (
"    STMFD   SP!, {R4,R5,LR} \n"
"    LDR     R2, =0x1C818 \n"
"    LDRH    R3, [R2] \n"
...
/*************************************************************/
//** sub_FF86738C_my @ 0xFF86738C - 0xFF867424, length=39
void __attribute__((naked,noinline)) sub_FF86738C_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    ADD     R5, R4, #0x1C \n"
