...
if (p[0]==(int)0xFFC5C1E8)  p[0]=(int)task_CaptSeqTask_my;
if (p[0]==(int)0xFFC95048)  p[0]=(int)exp_drv_task;
if (p[0]==(int)0xFFD138CC)  p[0]=(int)movie_record_task;
}
...
void __attribute__((naked,noinline)) sub_FFC00358_my() {
	...
	*(int*)(0x21B4)= (*(int*)0xC02200A8)&1 ? 0x200000 : 0x100000; // @ FFC43E14 replacement  for correct power-on.
...
void __attribute__((naked,noinline)) sub_FFC6CF5C_my() { 
 asm volatile (
