...
"    BL      sub_FF0050FC \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004324 /*'dmSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF003E48 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF00432C /*'termDriverInit'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF00433C /*'/_term'*/ \n"
"    BL      sub_FF003F30 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004344 /*'termDeviceCreate'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF00433C /*'/_term'*/ \n"
"    BL      sub_FF002950 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004358 /*'stdioSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF004A98 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004364 /*'stdlibSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF001650 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004370 /*'armlib_setup'*/ \n"
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
...
"    MOV     R0, #0 \n"
"    BL      sub_FF01EFEC \n"
"    BL      sub_00437A84 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF00A1B4.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF00A2A8 /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R3,PC} \n"
);
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x20B \n"
"    LDRNE   R0, =0xFF056DEC /*'RotaryEncoder.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP] \n"
"    AND     R4, R0, #0xFF \n"
"    AND     R0, R0, #0xFF00 \n"
...
"loc_FF056D8C:\n"
"    LDR     R0, =0xFF056DEC /*'RotaryEncoder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x278 \n"
"    LDREQ   R0, =0xFF056DEC /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
