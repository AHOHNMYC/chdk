...
static int nTxtbl[]={0,18,43,55,76,93,113,124};
	...
	defined(CAMERA_ixus970_sd890) || defined(CAMERA_ixus980_sd990) || defined(CAMERA_a1100) || defined(CAMERA_a3000)
#define ZSTEP_TABLE_SIZE 8
...
#if defined(CAMERA_sx200is) || defined(CAMERA_sx130is) || defined(CAMERA_sx150is) || defined(CAMERA_sx220hs) || defined(CAMERA_sx230hs)
#define ZSTEP_TABLE_SIZE 7
