...
/*************************************************************/
//** filewritetask @ 0xFF36D2D8 - 0xFF36D478, length=105
...
"    CMP     R0, #0 \n"
"    MOVNE   R1, #0x3EC \n"
"    LDRNE   R0, =0xFF36D4A4 /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xD \n"
...
"loc_FF36D3E0:\n"
"    BL      sub_FF36CFC4_my \n"  // --> Patched. Old value = 0xFF36CFC4. Open stage
"    B       loc_FF36D2E4 \n"
...
"loc_FF36D46C:\n"
"    BL      sub_FF36D680_my \n"  // --> Patched. Old value = 0xFF36D680. Write stage
"    B       loc_FF36D2E4 \n"

"loc_FF36D474:\n"
"    BL      sub_FF36D150_my \n"  // --> Patched. Old value = 0xFF36D150. Close stage
"    B       loc_FF36D2E4 \n"
);
}

/*************************************************************/
//** sub_FF36CFC4_my @ 0xFF36CFC4 - 0xFF36D14C, length=99
void __attribute__((naked,noinline)) sub_FF36CFC4_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF36D680_my @ 0xFF36D680 - 0xFF36D75C, length=56
void __attribute__((naked,noinline)) sub_FF36D680_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    ADD     R8, R8, R0 \n"
"    MOVCS   R1, #0x36C \n"
"    LDRCS   R0, =0xFF36D4A4 /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FF36D6CC \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_FF36D150_my @ 0xFF36D150 - 0xFF36D190, length=17
void __attribute__((naked,noinline)) sub_FF36D150_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
