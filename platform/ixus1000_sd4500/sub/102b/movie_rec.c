...
"		LDR	R6, =sub_FF986044_my\n" //__MovieRecorder.c__0 ;	LOCATION: MovieRecorder.c:0 // sub_FF986100 in 102B
...
"		B	loc_FF986794\n"
// havent bothered commenting all the 'real' locations below in the 102B fw and left as 100D
"loc_FF9866B4:\n"
"		B	loc_FF986744\n"
"loc_FF9866B8:\n"
"		B	loc_FF986768\n"
...
"		STR	R3, [SP]\n"
"		LDR	R0, [R4,#0x28]\n"
"       LDR     R3, =0xFF984CE4\n" // MovieRecorder.c Not present in 100D
"		MOV	R2, R9\n"
"		BL	sub_FF83B774\n"
"		B	loc_FF986670\n"
...
void __attribute__((naked,noinline)) sub_FF986044_my(){      // in sx200:sub_FF937C70_my in 102: FF986100
 asm volatile(
"		STMFD	SP!, {R4-R11,LR}\n"
"		SUB	SP, SP,	#0x64\n"
"		MOV	R8, #0\n"
...
"		STR	R8, [R7,#0x38]\n"
"		B	loc_FF9860F4\n"
//Other stuff??? was at the end - conf also in 102B
"loc_FF986C60:\n"
"LDR     R0, =0xB0330\n"
"LDR     R0, [R0,#8]\n"
"CMP     R0, #0\n"
