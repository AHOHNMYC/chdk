...
/*************************************************************/
//** dvlp_seq_task @ 0xFF07D4C4 - 0xFF07D598, length=54
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x76 \n"
"    LDREQ   R0, =0xFF07D67C /*'SsDvlpSeq.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    STR     R5, [R4, #4] \n"
"    LDR     R0, [R6, #4] \n"
"    ADD     R1, SP, #4 \n"
...
/*************************************************************/
//** sub_FF1D140C_my @ 0xFF1D140C - 0xFF1D1650, length=146
void __attribute__((naked,noinline)) sub_FF1D140C_my() {
asm volatile (
"    STMFD   SP!, {R3-R7,LR} \n"
"    LDR     R5, =0x409E0 \n"
"    MOV     R4, R0 \n"
...
"    TST     R0, #1 \n"
"    MOVNE   R1, #0xC5 \n"
"    LDRNE   R0, =0xFF1D1778 /*'SsCaptureSeq.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDRH    R0, [SP] \n"
"    CMP     R0, #1 \n"
"    BLS     loc_FF1D1624 \n"
