...
/*************************************************************/
//** sub_FFC04D38_my @ 0xFFC04D38 - 0xFFC04DAC, length=30
...
"    BL      sub_FFC090B4 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFFC04E4C /*'dmSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FFC04974 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFFC04E54 /*'termDriverInit'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFFC04E64 /*'/_term'*/ \n"
"    BL      sub_FFC04A5C \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFFC04E6C /*'termDeviceCreate'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFFC04E64 /*'/_term'*/ \n"
"    BL      sub_FFC03578 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFFC04E80 /*'stdioSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FFC08BCC \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFFC04E8C /*'stdlibSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FFC014A8 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFFC04E98 /*'armlib_setup'*/ \n"
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
...
/*************************************************************/
//** taskcreate_Startup_my @ 0xFFC0C260 - 0xFFC0C2D4, length=30
...
"    MOV     R0, #0 \n"
"    BL      sub_FFC171CC \n"
"    BL      sub_FFC16F78 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFFC0C1FC.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFFC0C2E0 /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R12,PC} \n"
);
...
/*************************************************************/
//** taskcreatePhySw_my @ 0xFFC11A14 - 0xFFC11A34, length=9
...
/*************************************************************/
//** init_file_modules_task @ 0xFFC61374 - 0xFFC613A8, length=14
...
/*************************************************************/
//** sub_FFC5ABB4_my @ 0xFFC5ABB4 - 0xFFC5ABBC, length=3
...
/*************************************************************/
//** sub_FFC3F454_my @ 0xFFC3F454 - 0xFFC3F4A8, length=22
...
/*************************************************************/
//** sub_FFC3F1F4_my @ 0xFFC3F1F4 - 0xFFC3F21C, length=11
...
/*************************************************************/
//** sub_FFC3EF84_my @ 0xFFC3EF84 - 0xFFC3F0EC, length=91
void __attribute__((naked,noinline)) sub_FFC3EF84_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R8, R0 \n"
"    LDR     R0, =0xE2FC \n"
