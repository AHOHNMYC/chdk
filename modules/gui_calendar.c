...
gui_handler GUI_MODE_CALENDAR = 
    /*GUI_MODE_CALENDAR*/   { GUI_MODE_MODULE, gui_calendar_draw, gui_calendar_kbd_process, gui_module_menu_kbd_process, 0, GUI_MODE_FLAG_NODRAWRESTORE };
...
void gui_calendar_draw() {
    ...
    draw_txt_string((camera_screen.ts_button_border/FONT_WIDTH)+8, 0, str, MAKE_COLOR(COLOR_BLACK, COLOR_WHITE));
