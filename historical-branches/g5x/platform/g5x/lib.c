...
void *vid_get_bitmap_fb()
{
    ...
    return yuv_buffers[active_bitmap_buffer&1];
}

// the opacity buffer defines opacity for the bitmap overlay's pixels
// found near BmpDDev.c
void *opacity_buffers[2] = { (void*)0x5FC40000, (void*)0x5FB80000 };

void *vid_get_opacity_active_buffer()
{
    return opacity_buffers[active_bitmap_buffer&1];
}
...
int vid_get_viewport_width_proper()             { return 720; }
