...
char *hook_raw_image_addr()
{
	...
	// Addresses below found in table at 0xFFB9AE00 used in sub_FF883610
	// checks [0x2E30 + 0xc] --> defines which buffer is active

	if (*((int*)0x2E3C) != 0)		// [0x2E30+0xC] look at routine starting at FF883610
		return (char*) 0x46000000;  // these two addresses found in table FFB9AE00 (used in FF883610)
	else
...
void *vid_get_viewport_live_fb()
{
	if ((mode_get()&MODE_MASK) == MODE_REC)
		return (void*)((void*)(*(int*)(0x2358))-vid_get_viewport_xoffset()*3);	//0x2358
...
void *vid_get_viewport_fb()
{
	...
	return (void*)0x405C6B80;  					                   // found by search for VRAM Address @FFB56344 (near to "VRAM Address")
