...
/*************************************************************/
//** exp_drv_task @ 0xFC2F6417, length=258 
...
/*************************************************************/
//** sub_fc2f3322_my @ 0xFC2F3323, length=53 jfw
void __attribute__((naked,noinline)) sub_fc2f3322_my() {
asm volatile (
            ...
            "    strh    r0, [r4, #0xc]\n"
            "    ldrsh.w r0, [r4, #6]\n"
            "    bl      sub_fc470d6a_my\n" // Patched (was sub_fc470d6a)
            "    ldr     pc, =0xfc2f33b5\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc470d6a_my @ 0xFC470D6B, length=35 
void __attribute__((naked,noinline)) sub_fc470d6a_my() {
asm volatile (
            "    push    {r4, r5, r6, lr}\n"
            "    ldr     r5, =0x0000fd5c\n"
            "    mov     r4, r0\n"
