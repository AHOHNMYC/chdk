...
void __attribute__((noreturn)) my_restart()
{
  ...
  core_copy(src, dst, length);
    ...
    //asm1989 apr2012 - sx260 @ FF026FBC   -> Looks the same as SX230 found at FF02D3D8
    asm volatile (
        "LDR     R1, =0xC0200000\n"
        "MVN     R0, #0\n"
        "STR     R0, [R1,#0x10C]\n"
...
//#define LED_PR 0xc022c200   // -> In sx260 it will we different for sure ASM1989 08.24.2010 sx230 found at   FF91E080  in sx200 was FF8E73D0
...
//         :::"r1","r0");
//
//    *p = 0xCF;                              // led off. instead of 0x44 asm1989 2012 !!! test it
//
//    while(1);
//}
...
//            asm ("nop\n");
//        }
//        p[0]=0xCF;                          // led off. instead of 0x44 asm1989 2012 !!! test it
//        for(i=0;i<0x200000;i++){
//            asm ("nop\n");
//            asm ("nop\n");
//        }
