...
/*************************************************************/
//** filewritetask @ 0xFF3AFD78 - 0xFF3AFEB8, length=81
...
"    CMP     R0, #0 \n"
"    LDRNE   R2, =0x476 \n"
"    LDRNE   R1, =0xFF3AFEEC /*'dwFWrite.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
#ifdef FILEWRITE_DEBUG_LOG
"ldr     r0, [sp,#8]\n"
...
"loc_FF3AFE6C:\n"
"    BL      sub_FF3AF9A0_my \n"  // --> Patched. Old value = 0xFF3AF9A0. msg 12 - open, main hook
"    B       loc_FF3AFD80 \n"
...
"loc_FF3AFEAC:\n"
"    BL      sub_FF3B0248_my \n"  // --> Patched. Old value = 0xFF3B0248. msg 0-6 - write chunk
"    B       loc_FF3AFD80 \n"

"loc_FF3AFEB4:\n"
"    BL      sub_FF3AFB78_my \n"  // --> Patched. Old value = 0xFF3AFB78. msg 0-7 - close
"    B       loc_FF3AFD80 \n"
);
}

/*************************************************************/
//** sub_FF3AF9A0_my @ 0xFF3AF9A0 - 0xFF3AFB74, length=118
void __attribute__((naked,noinline)) sub_FF3AF9A0_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF3B0248_my @ 0xFF3B0248 - 0xFF3B032C, length=58
void __attribute__((naked,noinline)) sub_FF3B0248_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    CMP     R4, R7 \n"
"    LDRCS   R2, =0x3DF \n"
"    LDRCS   R1, =0xFF3AFEEC /*'dwFWrite.c'*/ \n"
"    ADD     R8, R8, R0 \n"
"    MOVCS   R0, #0 \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
...
/*************************************************************/
//** sub_FF3AFB78_my @ 0xFF3AFB78 - 0xFF3AFC0C, length=38
void __attribute__((naked,noinline)) sub_FF3AFB78_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x50] \n"
