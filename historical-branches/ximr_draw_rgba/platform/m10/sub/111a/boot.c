...
// Install mzrm_sendmsg hook
"    bl      patch_mzrm_sendmsg\n"
...
void __attribute__((naked,noinline)) sub_fc0f94ae_my() {
    asm volatile ( // capdis -f=chdk -s=0xFC0F94AF -c=26 -jfw -stubs PRIMARY.BIN 0xfc000000
"    push    {r4, lr}\n"
"    bl      sub_fc1fb2d8\n"
"    movs    r1, #4\n"
"    movs    r0, #2\n"
...
void __attribute__((naked,noinline)) sub_fc08c4b8_my() {
    asm volatile ( // capdis -f=chdk -s=0xFC08C4B9 -c=10 -jfw -stubs PRIMARY.BIN 0xfc000000
"    push    {r4, r5, r6, r7, lr}\n"
"    ldr     r6, =0x000082cc\n" //  physw_run
"    sub     sp, #0x84\n"
"    ldr     r0, [r6]\n"
