...
"    MOV     R0, #0 \n"
"    BL      sub_FF02A8E0 \n"
"    BL      sub_FF02A688 /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
...
/*************************************************************/
//** sub_FF0902D0_my @ 0xFF0902D0 - 0xFF0902D8, length=3
void __attribute__((naked,noinline)) sub_FF0902D0_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    MOV     R0, #3 \n"
"    BL      sub_FF06C7C8_my \n"  // --> Patched. Old value = 0xFF06C7C8.
"    LDR     PC, =0xFF0902DC \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF06C7C8_my @ 0xFF06C7C8 - 0xFF06C81C, length=22
void __attribute__((naked,noinline)) sub_FF06C7C8_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R6, R0 \n"
"    BL      sub_FF06C778 \n"
...
"    BL      sub_FF06BFC0 \n"
"    MOV     R0, R5 \n"
"    BL      sub_FF06C31C_my \n"  // --> Patched. Old value = 0xFF06C31C.
"    LDR     PC, =0xFF06C820 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF06C31C_my @ 0xFF06C31C - 0xFF06C344, length=11
void __attribute__((naked,noinline)) sub_FF06C31C_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, =0x3F638 \n"
...
"    LDR     R0, [R4, #0x38] \n"
"    MOV     R1, R5 \n"
"    BL      sub_FF06C044_my \n"  // --> Patched. Old value = 0xFF06C044.
"    LDR     PC, =0xFF06C348 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF06C044_my @ 0xFF06C044 - 0xFF06C1B4, length=93
void __attribute__((naked,noinline)) sub_FF06C044_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R9, R0 \n"
"    LDR     R0, =0x3F638 \n"
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x256 \n"
"    LDRNE   R0, =0xFF05787C /*'RotaryEncoder.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP] \n"
"    AND     R4, R0, #0xFF \n"
"    AND     R0, R0, #0xFF00 \n"
...
"loc_FF05781C:\n"
"    LDR     R0, =0xFF05787C /*'RotaryEncoder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x2D4 \n"
"    LDREQ   R0, =0xFF05787C /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
