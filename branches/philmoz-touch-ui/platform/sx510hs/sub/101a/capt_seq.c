...
/*************************************************************/
//** sub_FF371D20_my @ 0xFF371D20 - 0xFF371DEC, length=52
void __attribute__((naked,noinline)) sub_FF371D20_my() {
asm volatile (
"    STMFD   SP!, {R2-R10,LR} \n"
"    LDR     R7, =0x2401C \n"
"    MOV     R4, R0 \n"
...
"    TST     R0, #1 \n"
"    LDRNE   R2, =0x17B \n"
"    LDRNE   R1, =0xFF371FD0 /*'SsStandardCaptureSeq.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #4] \n"
"    AND     R0, R0, #0xFF00 \n"
...
"    BL      sub_FF0D0290 \n"
"    MOV     R0, R4 \n"
"    BL      sub_FF371A04_my \n"  // --> Patched. Old value = 0xFF371A04.
"    LDR     PC, =0xFF371DF0 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF371A04_my @ 0xFF371A04 - 0xFF371A54, length=21
void __attribute__((naked,noinline)) sub_FF371A04_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    LDR     R6, =0x2401C \n"
"    MOV     R4, R0 \n"
