...
asm volatile (
            "    movs    r0, #3\n"
            "    push    {r4, lr}\n"
            "    bl      sub_fc3b7180_my\n" // Patched (was sub_fc3b7180)
            "    ldr     pc, =0xfc0c997f\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b7180_my @ 0xFC3B7181, length=26 jfw
void __attribute__((naked,noinline)) sub_fc3b7180_my() {
asm volatile (
            ...
            "    bl      sub_fc3b6aec\n"
            "    mov     r0, r5\n"
            "    bl      sub_fc3b6d4e_my\n" // Patched (was sub_fc3b6d4e)
            "    ldr     pc, =0xfc3b71c7\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b6d4e_my @ 0xFC3B6D4F, length=11 jfw
void __attribute__((naked,noinline)) sub_fc3b6d4e_my() {
asm volatile (
            "    push    {r4, r5, r6, lr}\n"
            "    mov     r5, r0\n"
            "    ldr     r0, =0x00044368\n"
            ...
            "    ldr     r0, [r4, #0x38]\n"
            "    mov     r1, r5\n"
            "    bl      sub_fc3b6b4a_my\n" // Patched (was sub_fc3b6b4a)
            "    ldr     pc, =0xfc3b6d67\n" // Continue in firmware
);
}

/*************************************************************/
//** sub_fc3b6b4a_my @ 0xFC3B6B4B, length=108 
void __attribute__((naked,noinline)) sub_fc3b6b4a_my() {
asm volatile (
            ...
            "branchtable_fc3b6b68:\n"
            "    .byte((loc_fc3b6b80 - branchtable_fc3b6b68) / 2)\n" // (case 0)
            "    .byte((loc_fc3b6b70 - branchtable_fc3b6b68) / 2)\n" // (case 1)
            "    .byte((loc_fc3b6b70 - branchtable_fc3b6b68) / 2)\n" // (case 2)
            "    .byte((loc_fc3b6b70 - branchtable_fc3b6b68) / 2)\n" // (case 3)
            "    .byte((loc_fc3b6b70 - branchtable_fc3b6b68) / 2)\n" // (case 4)
            "    .byte((loc_fc3b6c40 - branchtable_fc3b6b68) / 2)\n" // (case 5)
            "    .byte((loc_fc3b6b70 - branchtable_fc3b6b68) / 2)\n" // (case 6)
            ".align 1\n"
            "loc_fc3b6b70:\n"
            "    movs    r2, #0\n"
...
/*************************************************************/
//** task_TricInitTask_my @ 0xFC5422B1, length=35 
