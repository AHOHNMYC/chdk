...
void __attribute__((naked,noinline)) init_file_modules_task() {
	asm volatile(
			...
			"MOVNE   R0, R5\n"
			"BLNE    sub_FFC6C5A8\n"
			"BL      sub_FFC69D4C_my\n"			//------------->  // xxxshould I change function name to match address?
...
//** sub_FFC69D4C_my  @ 0xFFC69D4C changed name of sub to match address xxx
//used to be sub_FFC69D9C_my
void __attribute__((naked,noinline)) sub_FFC69D4C_my() { //xxx
	asm volatile(
			"STMFD   SP!, {R4,LR}\n"
			"MOV     R0, #3\n"
			"BL      sub_FFC50E90_my\n"			//---------->
