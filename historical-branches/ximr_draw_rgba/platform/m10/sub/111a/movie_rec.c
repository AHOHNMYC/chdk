...
void __attribute__((naked,noinline)) sub_fc10099a_my() {
    asm volatile (
// capdis -f=chdk -s=0xfc10099b -c=16 -jfw -stubs PRIMARY.BIN 0xfc000000
...
// !!! 111a porting note: struct content and length matches 110d,
// !!! offset and length calculations below use 110d addresses
void __attribute__((naked,noinline)) task_cocoa0() {
    asm volatile (
".equ   COCOA_ARR_START,    0xfc65d4a8\n"
".equ   COCOA_ARR_LEN,      (0xFC65D92C-0xFC65D440)\n"
".equ   COCOA_APENDSTR_OFS, (0xFC65D494-0xFC65D440)\n"
...
// capdis -f=chdk -s=task_TskCocoa0 -c=3 -stubs PRIMARY.BIN 0xfc000000
// task_TskCocoa0 0xfc255eab
"    mov     r1, r0\n"
"    movs    r0, #0\n"
//"    b       loc_fc255c14\n"  // -

// capdis -f=chdk -s=0xfc255c15 -c=22 -jfw -stubs PRIMARY.BIN 0xfc000000
"    push.w  {r4, r5, r6, r7, r8, sb, sl, fp, lr}\n"
"    cmp     r0, #2\n"
"    mov     r4, r1\n"
"    sub     sp, #0x15c\n"
