...
/*************************************************************/
//** sub_FF090304_my @ 0xFF090304 - 0xFF09030C, length=3
void __attribute__((naked,noinline)) sub_FF090304_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    MOV     R0, #3 \n"
"    BL      sub_FF06C7FC_my \n"  // --> Patched. Old value = 0xFF06C7FC.
"    LDR     PC, =0xFF090310 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF06C7FC_my @ 0xFF06C7FC - 0xFF06C850, length=22
void __attribute__((naked,noinline)) sub_FF06C7FC_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R6, R0 \n"
"    BL      sub_FF06C7AC \n"
...
"    BL      sub_FF06BFF4 \n"
"    MOV     R0, R5 \n"
"    BL      sub_FF06C350_my \n"  // --> Patched. Old value = 0xFF06C350.
"    LDR     PC, =0xFF06C854 \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF06C350_my @ 0xFF06C350 - 0xFF06C378, length=11
void __attribute__((naked,noinline)) sub_FF06C350_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, =0x3F658 \n"
...
"    LDR     R0, [R4, #0x38] \n"
"    MOV     R1, R5 \n"
"    BL      sub_FF06C078_my \n"  // --> Patched. Old value = 0xFF06C078.
"    LDR     PC, =0xFF06C37C \n"  // Continue in firmware
);
}

/*************************************************************/
//** sub_FF06C078_my @ 0xFF06C078 - 0xFF06C1E8, length=93
void __attribute__((naked,noinline)) sub_FF06C078_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R9, R0 \n"
"    LDR     R0, =0x3F658 \n"
