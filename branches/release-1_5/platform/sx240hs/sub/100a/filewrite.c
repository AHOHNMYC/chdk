...
/*************************************************************/
//** filewritetask @ 0xFF32E778 - 0xFF32E8BC, length=82
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x38E \n"
"    LDRNE   R0, =0xFF32E8BC /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xB \n"
...
"loc_FF32E850:\n"
"    BL      sub_FF32E474_my \n"  // --> Patched. Old value = 0xFF32E474. Open stage
"    B       loc_FF32E784 \n"
...
"loc_FF32E88C:\n"
"    BL      sub_FF32EAB4_my \n"  // --> Patched. Old value = 0xFF32EAB4. Write stage
"    B       loc_FF32E784 \n"

"loc_FF32E894:\n"
"    BL      sub_FF32E5E0_my \n"  // --> Patched. Old value = 0xFF32E5E0. Close stage
"    B       loc_FF32E784 \n"
);
}

/*************************************************************/
//** sub_FF32E474_my @ 0xFF32E474 - 0xFF32E5DC, length=91
void __attribute__((naked,noinline)) sub_FF32E474_my() {
asm volatile (
"    STMFD   SP!, {R4-R9,LR} \n"
"    LDR     R6, =0xF19C \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FF32EAB4_my @ 0xFF32EAB4 - 0xFF32EB90, length=56
void __attribute__((naked,noinline)) sub_FF32EAB4_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    ADD     R8, R8, R0 \n"
"    MOVCS   R1, #0x308 \n"
"    LDRCS   R0, =0xFF32E8BC /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FF32EB00 \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_FF32E5E0_my @ 0xFF32E5E0 - 0xFF32E774, length=102
void __attribute__((naked,noinline)) sub_FF32E5E0_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x50] \n"
...
"    CMP     R0, #0 \n"
"    LDREQ   R1, =0x346 \n"
"    LDREQ   R0, =0xFF32E8BC /*'dwFWrite.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    LDR     R0, [SP, #0x28] \n"
"    LDR     R1, [R4, #4] \n"
"    ADD     R0, R0, R1 \n"
