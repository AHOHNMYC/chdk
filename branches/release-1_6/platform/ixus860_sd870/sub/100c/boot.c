...
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
"    B       CreateTask_Startup_my \n"  // --> Patched. Old value = 0xFF81DCD4.
);
}

/*************************************************************/
//** CreateTask_Startup_my @ 0xFF81DCD4 - 0xFF81DD48, length=30
...
/*************************************************************/
//** task_Startup_my @ 0xFF81DC78 - 0xFF81DCD0, length=23
...
/*************************************************************/
//** taskcreatePhySw_my @ 0xFF822DAC - 0xFF822DE0, length=14
...
/*************************************************************/
//** init_file_modules_task @ 0xFF870CE8 - 0xFF870D1C, length=14
...
/*************************************************************/
//** sub_FF869D2C_my @ 0xFF869D2C - 0xFF869D64, length=15
void __attribute__((naked,noinline)) sub_FF869D2C_my() {
asm volatile (
"    STMFD   SP!, {R4,LR} \n"
"    BL      sub_FF84D4A8_my \n"  // --> Patched. Old value = 0xFF84D4A8.
"    LDR     R4, =0x58A8 \n"
"    LDR     R0, [R4, #4] \n"
"    CMP     R0, #0 \n"
"    BNE     loc_FF869D5C \n"
...
/*************************************************************/
//** sub_FF84D4A8_my @ 0xFF84D4A8 - 0xFF84D540, length=39
void __attribute__((naked,noinline)) sub_FF84D4A8_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R6, #0 \n"
"    MOV     R0, R6 \n"
...
/*************************************************************/
//** sub_FF84D2E4_my @ 0xFF84D2E4 - 0xFF84D34C, length=27
void __attribute__((naked,noinline)) sub_FF84D2E4_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    LDR     R5, =0x2B3C \n"
"    MOV     R6, R0 \n"
...
/*************************************************************/
//** sub_FF84D17C_my @ 0xFF84D17C - 0xFF84D2E0, length=90
void __attribute__((naked,noinline)) sub_FF84D17C_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R8, R0 \n"
"    MOV     R0, #0x17 \n"
