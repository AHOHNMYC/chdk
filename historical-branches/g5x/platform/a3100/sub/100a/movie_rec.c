...
/*************************************************************/
//** movie_record_task @ 0xFF92DB3C - 0xFF92DC40, length=66
...
"loc_FF92DC24:\n"
"    LDR     R1, [SP, #4] \n"
"    LDR     R3, =0xFF92D010 /*'MovieRecorder.c'*/ \n"
"    STR     R6, [R1] \n"
"    STR     R8, [SP] \n"
"    LDR     R0, [R4, #0x1C] \n"
"    MOV     R2, R7 \n"
...
/*************************************************************/
//** sub_FF92D648_my @ 0xFF92D648 - 0xFF92D848, length=129
void __attribute__((naked,noinline)) sub_FF92D648_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    SUB     SP, SP, #0x40 \n"
"    MOV     R6, #0 \n"
...
"loc_FF92D7BC:\n"
"    BL      sub_FF882CCC /*_HardwareDefect_FW*/ \n"
"    B       loc_FF92D720 \n"
...
"    MUL     R0, R1, R0 \n"
"    LDR     R1, [R5, #0x48] \n"
"    BL      sub_FFAD71C8 /*__divmod_unsigned_int*/ \n"
"    MOV     R4, R0 \n"
"    BL      sub_FFA40054 \n"
"    LDR     R1, [R5, #0x80] \n"
"    CMP     R1, R4 \n"
...
/*************************************************************/
//** sub_FFA3DBE8_my @ 0xFFA3DBE8 - 0xFFA3DCC8, length=57
void __attribute__((naked,noinline)) sub_FFA3DBE8_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    LDR     R4, =0x97F0 \n"
"    LDR     LR, [R4] \n"
