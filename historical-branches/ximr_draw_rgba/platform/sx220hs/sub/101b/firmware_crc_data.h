...
const firmware_crc_block_t firmware_101b_crc32[]={
    { (const char *)0xff000000,   0x3aff32, 0xa4d72c68 }, // ROMCODE
    { (const char *)0xff4a9bc4,    0x10220, 0xf885bf01 }, // RAM data
};

const firmware_crc_block_t firmware_101c_crc32[]={
    { (const char *)0xff000000,   0x3aff32, 0x4b8ba51e }, // ROMCODE
    { (const char *)0xff4a9bc4,    0x10220, 0xf885bf01 }, // RAM data
};

const firmware_crc_block_t firmware_101e_crc32[]={
    { (const char *)0xff000000,   0x3aff32,  0x7505de1 }, // ROMCODE
    { (const char *)0xff4a9bc4,    0x10220, 0xf885bf01 }, // RAM data
};
