...
"    BL      sub_FF005358 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004330 /*'dmSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF003E54 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004338 /*'termDriverInit'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF004348 /*'/_term'*/ \n"
"    BL      sub_FF003F3C \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004350 /*'termDeviceCreate'*/ \n"
"    BLLT    _err_init_task \n"
"    LDR     R0, =0xFF004348 /*'/_term'*/ \n"
"    BL      sub_FF00295C \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004364 /*'stdioSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF004CF4 \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF004370 /*'stdlibSetup'*/ \n"
"    BLLT    _err_init_task \n"
"    BL      sub_FF00165C \n"
"    CMP     R0, #0 \n"
"    LDRLT   R0, =0xFF00437C /*'armlib_setup'*/ \n"
"    BLLT    _err_init_task \n"
"    LDMFD   SP!, {R4,LR} \n"
...
"    MOV     R0, #0 \n"
"    BL      sub_FF020604 \n"
"    BL      sub_0068C52C /*_EnableDispatch*/ \n"
"    MOV     R3, #0 \n"
"    STR     R3, [SP] \n"
"    LDR     R3, =task_Startup_my \n"  // --> Patched. Old value = 0xFF00ADF4.
"    MOV     R2, #0 \n"
"    MOV     R1, #0x19 \n"
"    LDR     R0, =0xFF00AEE4 /*'Startup'*/ \n"
"    BL      _CreateTask \n"
"    MOV     R0, #0 \n"
"    LDMFD   SP!, {R3,PC} \n"
);
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x20B \n"
"    LDRNE   R0, =0xFF05DF0C /*'RotaryEncoder.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP] \n"
"    AND     R4, R0, #0xFF \n"
"    AND     R0, R0, #0xFF00 \n"
...
"loc_FF05DEAC:\n"
"    LDR     R0, =0xFF05DF0C /*'RotaryEncoder.c'*/ \n"
"    BL      _DebugAssert \n"
...
"    CMP     R0, #0 \n"
"    MOVEQ   R1, #0x278 \n"
"    LDREQ   R0, =0xFF05DF0C /*'RotaryEncoder.c'*/ \n"
"    BLEQ    _DebugAssert \n"
"    RSB     R0, R4, R4, LSL#3 \n"
"    ADD     R0, R6, R0, LSL#2 \n"
"    LDR     R0, [R0, #0xC] \n"
