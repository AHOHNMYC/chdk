...
/*************************************************************/
//** sub_FF3BE1E8_my @ 0xFF3BE1E8 - 0xFF3BE768, length=353
void __attribute__((naked,noinline)) sub_FF3BE1E8_my() {
asm volatile (
"    STMFD   SP!, {R0-R11,LR} \n"
"    MOV     R9, R0 \n"
"    LDR     R0, [R3, #0x10] \n"
...
"    LDR     R7, [SP, #0x40] \n"
"    LDREQ   R1, =0x36A \n"
"    LDREQ   R0, =0xFF3BC4D8 /*'MovWriter.c'*/ \n"
"    MOV     R6, #0 \n"
"    MOV     R4, R3 \n"
"    MOV     R5, R6 \n"
"    BLEQ    _DebugAssert \n"
...
"    CMP     R0, #0x10 \n"
"    LDRNE   R1, =0x48D \n"
"    LDRNE   R0, =0xFF3BC4D8 /*'MovWriter.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    MOV     R0, #1 \n"
"    STR     R0, [R5, #0xDC] \n"
"    LDRH    R0, [R5, #4] \n"
