...
__stdcall int Fopen_Fut(const char *filename, const char *mode);
__stdcall int Fclose_Fut(int file);
__stdcall int Fread_Fut(void *buf, int elsize, int count, int f);
__stdcall int Fwrite_Fut(const void *buf, int elsize, int count, int f);
__stdcall int Fseek_Fut(int file, int offset, int whence);
__stdcall int Fflush_Fut(int file);
__stdcall int Feof_Fut(int file);
__stdcall int Fflush_Fut(int file);
__stdcall char * Fgets_Fut(char *buf, int n, int f);
