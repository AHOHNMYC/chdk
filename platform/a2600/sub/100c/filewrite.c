...
/*************************************************************/
//** filewritetask @ 0xFFA75CC4 - 0xFFA75E64, length=105
...
"    CMP     R0, #0 \n"
"    LDRNE   R1, =0x3EF \n"
"    LDRNE   R0, =0xFFA75E90 /*'dwFWrite.c'*/ \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    LDR     R1, [R0] \n"
"    CMP     R1, #0xD \n"
...
"loc_FFA75DCC:\n"
"    BL      sub_FFA759B0_my \n"  // --> Patched. Old value = 0xFFA759B0. Open stage
"    B       loc_FFA75CD0 \n"
...
"loc_FFA75E58:\n"
"    BL      sub_FFA76070_my \n"  // --> Patched. Old value = 0xFFA76070. Write stage
"    B       loc_FFA75CD0 \n"

"loc_FFA75E60:\n"
"    BL      sub_FFA75B3C_my \n"  // --> Patched. Old value = 0xFFA75B3C. Close stage
"    B       loc_FFA75CD0 \n"
);
}

/*************************************************************/
//** sub_FFA759B0_my @ 0xFFA759B0 - 0xFFA75B38, length=99
void __attribute__((naked,noinline)) sub_FFA759B0_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
...
/*************************************************************/
//** sub_FFA76070_my @ 0xFFA76070 - 0xFFA7614C, length=56
void __attribute__((naked,noinline)) sub_FFA76070_my() {
asm volatile (
"    STMFD   SP!, {R4-R10,LR} \n"
"    MOV     R5, R0 \n"
"    LDR     R0, [R0] \n"
...
"    LDRCS   R1, =0x36F \n"
"    ADD     R8, R8, R0 \n"
"    LDRCS   R0, =0xFFA75E90 /*'dwFWrite.c'*/ \n"
"    BLCS    _DebugAssert \n"
"    CMP     R4, #0 \n"
"    BNE     loc_FFA760BC \n"
"    LDR     R0, [R5] \n"
...
/*************************************************************/
//** sub_FFA75B3C_my @ 0xFFA75B3C - 0xFFA75B7C, length=17
void __attribute__((naked,noinline)) sub_FFA75B3C_my() {
asm volatile (
"    STMFD   SP!, {R4-R6,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x4C] \n"
