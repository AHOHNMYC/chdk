...
// G16 1.01a  0xfc070d8b 18 = taskcreate_physw
...
void __attribute__((naked,noinline)) sub_fc1b4be0_my() {
    asm volatile(
...
"branchtable_fc1b4c48:\n"
"    .byte((loc_fc1b4cd4 - branchtable_fc1b4c48) / 2)\n" // (case 0)
"    .byte((loc_fc1b4c58 - branchtable_fc1b4c48) / 2)\n" // (case 1)
"    .byte((loc_fc1b4c58 - branchtable_fc1b4c48) / 2)\n" // (case 2)
"    .byte((loc_fc1b4cde - branchtable_fc1b4c48) / 2)\n" // (case 3)
"    .byte((loc_fc1b4cd4 - branchtable_fc1b4c48) / 2)\n" // (case 4)
"    .byte((loc_fc1b4cde - branchtable_fc1b4c48) / 2)\n" // (case 5)
"    .byte((loc_fc1b4c84 - branchtable_fc1b4c48) / 2)\n" // (case 6)
"    .byte((loc_fc1b4c84 - branchtable_fc1b4c48) / 2)\n" // (case 7)
"    .byte((loc_fc1b4c58 - branchtable_fc1b4c48) / 2)\n" // (case 8)
"    .byte((loc_fc1b4c58 - branchtable_fc1b4c48) / 2)\n" // (case 9)
"    .byte((loc_fc1b4cd4 - branchtable_fc1b4c48) / 2)\n" // (case 10)
