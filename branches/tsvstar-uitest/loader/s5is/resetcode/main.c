...
#define DP (void*)0xC02200c4	// direct-print (blue) NOT ON S5. Controlled with UniqueLedOn, not required.
#define DELAY 5000000

void __attribute__((noreturn)) copy_and_restart(void *dst_void, const void *src_void, long length) {

        //volatile long *p = (void*)DP;       // turned off later, so assumed to be power DO NOT USE ON S5
