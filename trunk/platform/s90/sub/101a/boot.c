...
p-=17;
if (p[0]==(int)0xFF87A208)  p[0]=(int)capt_seq_task;
if (p[0]==(int)0xFF961780)  p[0]=(int)movie_record_task;
if (p[0]==(int)0xFF898314)  p[0]=(int)init_file_modules_task;
if (p[0]==(int)0xFF8C0E80)  p[0]=(int)exp_drv_task;
if (p[0]==(int)0xFF85E508)  p[0]=(int)JogDial_task_my;
if (p[0]==(int)0xFFA78FF4)  p[0]=(int)filewritetask;
}
