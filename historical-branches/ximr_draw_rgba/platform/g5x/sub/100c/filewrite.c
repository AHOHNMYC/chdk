...
/*************************************************************/
//** filewritetask @ 0xFC4E8429, length=43 
...
asm volatile (
            ...
            "    b       loc_fc4e8434\n"
            "loc_fc4e8498:\n"
            "    bl      sub_fc4e8732_my\n" // Patched (was sub_fc4e8732)
            "    b       loc_fc4e8434\n"
            "loc_fc4e849e:\n"
            "    bl      sub_fc4e82de_my\n" // Patched (was sub_fc4e82de)
            "    b       loc_fc4e8434\n"
);
}

/*************************************************************/
//** sub_fc4e81ac_my @ 0xFC4E81AD, length=126 
void __attribute__((naked,noinline)) sub_fc4e81ac_my() {
asm volatile (
...
/*************************************************************/
//** sub_fc4e8732_my @ 0xFC4E8733, length=65 
void __attribute__((naked,noinline)) sub_fc4e8732_my() {
asm volatile (
            ...
            "    mov     r2, r1\n"
            "    mov     r1, r7\n"
            "    bl      fwt_write\n" // j_Write_FW // Patched (was sub_fc3b5d9c)
            "    ldr     r1, [r5, #4]\n"
            "    cmp     r8, r0\n"
            "    add     r1, r0\n"
            "    str     r1, [r5, #4]\n"
...
/*************************************************************/
//** sub_fc4e82de_my @ 0xFC4E82DF, length=141 
void __attribute__((naked,noinline)) sub_fc4e82de_my() {
asm volatile (
            "    push    {r4, r5, r6, r7, lr}\n"
            "    mov     r4, r0\n"
            "    ldr     r0, [r0, #0x50]\n"
